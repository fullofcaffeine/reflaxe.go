	...
	public static function emit(classMetadata:Array<{goTypeName:String, haxeTypeName:String}>,
		...
		return [
			...
			GoDecl.GoFuncDecl("hxrt_serializerWriteObjectMapToken", null, [
				...
				{name: "entries", typeName: "[]hxrt.ObjectMapEntry"}
			], [], [
				GoStmt.GoRaw("hxrt_serializerAppend(self, \"M\")"),
				GoStmt.GoRaw("for _, entry := range entries {"),
				GoStmt.GoRaw("\thxrt_serializerWriteValue(self, entry.Key)"),
				GoStmt.GoRaw("\thxrt_serializerWriteValue(self, entry.Value)"),
				GoStmt.GoRaw("}"),
				GoStmt.GoRaw("hxrt_serializerAppend(self, \"h\")")
			]),
			...
			GoDecl.GoFuncDecl("hxrt_serializerTryDateStruct", null, [
				...
				GoStmt.GoRaw("\treturn false"),
				GoStmt.GoRaw("}"),
				GoStmt.GoRaw("msField := ref.FieldByName(\"ms\")"),
				GoStmt.GoRaw("if !msField.IsValid() || msField.Kind() != reflect.Float64 {"),
				GoStmt.GoRaw("\treturn false"),
				GoStmt.GoRaw("}"),
				GoStmt.GoRaw("ms := msField.Float()"),
			...
			GoDecl.GoFuncDecl("hxrt_serializerWriteValue", null, [
				...
				GoStmt.GoRaw("\t\t\treturn"),
				GoStmt.GoRaw("\t\t}"),
				GoStmt.GoRaw("\t\titerator := current.iterator()"),
				GoStmt.GoRaw("\t\titems := make([]any, 0, current.length)"),
				GoStmt.GoRaw("\t\tfor iterator.hasNext() {"),
				GoStmt.GoRaw("\t\t\titems = append(items, iterator.next())"),
				GoStmt.GoRaw("\t\t}"),
				...
				GoStmt.GoRaw("\t\t\treturn"),
				GoStmt.GoRaw("\t\t}"),
				GoStmt.GoRaw("\t\thxrt_serializerWriteStringMapToken(self, hxrt.StringMapSnapshot(current.h))"),
				GoStmt.GoRaw("\t}"),
				GoStmt.GoRaw("\treturn"),
				...
				GoStmt.GoRaw("\t\t\treturn"),
				GoStmt.GoRaw("\t\t}"),
				GoStmt.GoRaw("\t\thxrt_serializerWriteIntMapToken(self, hxrt.IntMapSnapshot(current.h))"),
				GoStmt.GoRaw("\t}"),
				GoStmt.GoRaw("\treturn"),
				...
				GoStmt.GoRaw("\t\t\treturn"),
				GoStmt.GoRaw("\t\t}"),
				GoStmt.GoRaw("\t\thxrt_serializerWriteObjectMapToken(self, hxrt.ObjectMapSnapshot(current.h))"),
				GoStmt.GoRaw("\t}"),
				GoStmt.GoRaw("\treturn"),
			...
			GoDecl.GoFuncDecl("haxe__Unserializer_readValue", null, [
				...
				GoStmt.GoRaw("\t\t\tbreak"),
				GoStmt.GoRaw("\t\t}"),
				GoStmt.GoRaw("\t\tlist.add(haxe__Unserializer_readValue(self))"),
				...
				GoStmt.GoRaw("\t\thxrt.StringMapSet(stringMap.h, hxrt.StringFromLiteral(key), haxe__Unserializer_readValue(self))"),
				...
				GoStmt.GoRaw("\t\thxrt.IntMapSet(intMap.h, key, haxe__Unserializer_readValue(self))"),
				...
				GoStmt.GoRaw("\t\thxrt.ObjectMapSet(objectMap.h, key, haxe__Unserializer_readValue(self))"),
