...
| `sys.net.Socket.bind` | `operation` | `semantic-diff-supported` | no | `semantic:socket`, `semantic:socket-server-lifecycle`, `snapshot:socket-server-lifecycle`, `runtime:socket-regressions`, `runtime:socket-listener-linux`, `runtime:socket-cross-build`, `policy:socket-server-lifecycle`, `bead:network-audit` | The operation-level candidate preserves the Haxe bind-then-listen lifecycle: bind reserves a numeric IPv4 endpoint without accepting, listen passes each nonnegative backlog request to the OS, duplicate listen reapplies it, and close releases either state. Deterministic generated-Haxe, native lifecycle/TLS/concurrency, and Linux bounded-pending-queue evidence exist; Windows remains compile-only. Release admission stays fail-closed pending the advanced socket review. |
| `sys.net.Socket.listen` | `operation` | `semantic-diff-supported` | no | `semantic:socket`, `semantic:socket-server-lifecycle`, `snapshot:socket-server-lifecycle`, `runtime:socket-regressions`, `runtime:socket-listener-linux`, `runtime:socket-cross-build`, `policy:socket-server-lifecycle`, `bead:network-audit` | The operation-level candidate preserves the Haxe bind-then-listen lifecycle: bind reserves a numeric IPv4 endpoint without accepting, listen passes each nonnegative backlog request to the OS, duplicate listen reapplies it, and close releases either state. Deterministic generated-Haxe, native lifecycle/TLS/concurrency, and Linux bounded-pending-queue evidence exist; Windows remains compile-only. Release admission stays fail-closed pending the advanced socket review. |
| `sys.net.Socket.accept` | `operation` | `semantic-diff-supported` | no | `semantic:socket`, `semantic:socket-server-lifecycle`, `snapshot:socket-server-lifecycle`, `runtime:socket-regressions`, `runtime:socket-listener-linux`, `runtime:socket-cross-build`, `policy:socket-server-lifecycle`, `bead:network-audit` | The operation-level candidate preserves the Haxe bind-then-listen lifecycle: bind reserves a numeric IPv4 endpoint without accepting, listen passes each nonnegative backlog request to the OS, duplicate listen reapplies it, and close releases either state. Deterministic generated-Haxe, native lifecycle/TLS/concurrency, and Linux bounded-pending-queue evidence exist; Windows remains compile-only. Release admission stays fail-closed pending the advanced socket review. |
| `sys.net.Socket.setTimeout` | `operation` | `semantic-diff-supported` | no | `semantic:socket`, `semantic:socket-readiness`, `snapshot:socket-readiness`, `runtime:socket-regressions`, `runtime:socket-readiness-posix`, `runtime:socket-cross-build`, `policy:socket-readiness`, `bead:network-audit` | The operation-level candidate uses operating-system read, write, and exceptional readiness on Linux and Darwin, preserves buffered bytes, EOF, duplicate indexes, and public Socket identity, and proves prompt Blocked behavior for connected nonblocking read/write/accept. Socket.setTimeout still does not bound Host construction or reverse lookup. Linux has runtime evidence; Darwin has local runtime evidence; Windows remains compile-only and explicitly unsupported at runtime. Release admission stays fail-closed pending the advanced socket review. |
| `sys.net.Socket.setBlocking` | `operation` | `semantic-diff-supported` | no | `semantic:socket`, `semantic:socket-readiness`, `snapshot:socket-readiness`, `runtime:socket-regressions`, `runtime:socket-readiness-posix`, `runtime:socket-cross-build`, `policy:socket-readiness`, `bead:network-audit` | The operation-level candidate uses operating-system read, write, and exceptional readiness on Linux and Darwin, preserves buffered bytes, EOF, duplicate indexes, and public Socket identity, and proves prompt Blocked behavior for connected nonblocking read/write/accept. Socket.setTimeout still does not bound Host construction or reverse lookup. Linux has runtime evidence; Darwin has local runtime evidence; Windows remains compile-only and explicitly unsupported at runtime. Release admission stays fail-closed pending the advanced socket review. |
| `sys.net.Socket.select` | `operation` | `semantic-diff-supported` | no | `semantic:socket`, `semantic:socket-readiness`, `snapshot:socket-readiness`, `runtime:socket-regressions`, `runtime:socket-readiness-posix`, `runtime:socket-cross-build`, `policy:socket-readiness`, `bead:network-audit` | The operation-level candidate uses operating-system read, write, and exceptional readiness on Linux and Darwin, preserves buffered bytes, EOF, duplicate indexes, and public Socket identity, and proves prompt Blocked behavior for connected nonblocking read/write/accept. Socket.setTimeout still does not bound Host construction or reverse lookup. Linux has runtime evidence; Darwin has local runtime evidence; Windows remains compile-only and explicitly unsupported at runtime. Release admission stays fail-closed pending the advanced socket review. |
| `sys.net.Socket.waitForRead` | `operation` | `semantic-diff-supported` | no | `semantic:socket`, `semantic:socket-readiness`, `snapshot:socket-readiness`, `runtime:socket-regressions`, `runtime:socket-readiness-posix`, `runtime:socket-cross-build`, `policy:socket-readiness`, `bead:network-audit` | The operation-level candidate uses operating-system read, write, and exceptional readiness on Linux and Darwin, preserves buffered bytes, EOF, duplicate indexes, and public Socket identity, and proves prompt Blocked behavior for connected nonblocking read/write/accept. Socket.setTimeout still does not bound Host construction or reverse lookup. Linux has runtime evidence; Darwin has local runtime evidence; Windows remains compile-only and explicitly unsupported at runtime. Release admission stays fail-closed pending the advanced socket review. |
| `sys.net.Socket.shutdown` | `operation` | `compile-go-test-run-supported` | no | `semantic:socket`, `snapshot:socket-tls`, `runtime:socket-regressions`, `runtime:socket-tls-controls-posix`, `runtime:socket-cross-build`, `policy:socket-tls-controls`, `bead:network-audit` | The operation-level candidate preserves plain TCP read/write half-close, sends TLS close_notify for write-only shutdown while retaining the caller's read side, and defines that TLS read-only shutdown is explicitly unsupported. It closes both TLS sides idempotently and applies setFastSend to the underlying TCP_NODELAY option through a typed TLS NetConn boundary. Generated-Haxe and native POSIX tests cover wire-visible EOF, preserved response reads, option-state changes, repetition, and concurrent close. Release admission stays fail-closed pending the advanced socket review. |
| `sys.net.Socket.setFastSend` | `operation` | `compile-go-test-run-supported` | no | `semantic:socket`, `snapshot:socket-tls`, `runtime:socket-regressions`, `runtime:socket-tls-controls-posix`, `runtime:socket-cross-build`, `policy:socket-tls-controls`, `bead:network-audit` | The operation-level candidate preserves plain TCP read/write half-close, sends TLS close_notify for write-only shutdown while retaining the caller's read side, and defines that TLS read-only shutdown is explicitly unsupported. It closes both TLS sides idempotently and applies setFastSend to the underlying TCP_NODELAY option through a typed TLS NetConn boundary. Generated-Haxe and native POSIX tests cover wire-visible EOF, preserved response reads, option-state changes, repetition, and concurrent close. Release admission stays fail-closed pending the advanced socket review. |
| `new sys.net.Host("hostname")` | `operation` | `experimental` | no | `semantic:socket`, `runtime:socket-regressions`, `policy:socket-dns-boundary`, `bead:network-audit` | By compatibility decision, new Host(name) preserves Haxe 4.3.7 behavior and resolves a hostname synchronously during construction, before a Socket exists. Socket.setTimeout therefore cannot bound or cancel it. Host.reverse is a separate synchronous reverse lookup, and Host.localhost reads the OS hostname; none is admitted as bounded DNS behavior. |
| `sys.net.Host.reverse` | `operation` | `experimental` | no | `semantic:socket`, `runtime:socket-regressions`, `policy:socket-dns-boundary`, `bead:network-audit` | By compatibility decision, new Host(name) preserves Haxe 4.3.7 behavior and resolves a hostname synchronously during construction, before a Socket exists. Socket.setTimeout therefore cannot bound or cancel it. Host.reverse is a separate synchronous reverse lookup, and Host.localhost reads the OS hostname; none is admitted as bounded DNS behavior. |
| `sys.net.Host.localhost` | `operation` | `experimental` | no | `semantic:socket`, `runtime:socket-regressions`, `policy:socket-dns-boundary`, `bead:network-audit` | By compatibility decision, new Host(name) preserves Haxe 4.3.7 behavior and resolves a hostname synchronously during construction, before a Socket exists. Socket.setTimeout therefore cannot bound or cancel it. Host.reverse is a separate synchronous reverse lookup, and Host.localhost reads the OS hostname; none is admitted as bounded DNS behavior. |
| `sys.net.UdpSocket` | `surface` | `experimental` | no | `semantic:socket`, `runtime:socket-regressions`, `runtime:socket-cross-build`, `bead:network-audit` | Native and generated-Haxe loopback evidence preserves sender identity for both empty and non-empty IPv4 datagrams. UDP remains experimental because the complete timeout, nonblocking, hostile-peer, and cross-platform runtime contract is not admitted. |
| `sys.ssl.Socket` | `surface` | `experimental` | no | `snapshot:socket-tls`, `snapshot:socket-sni`, `runtime:socket-regressions`, `runtime:socket-tls-controls-posix`, `runtime:socket-cross-build`, `policy:socket-tls-controls`, `bead:network-audit` | Deterministic local-CA runtime evidence proves that direct TLS dials a resolved IPv4 address while retaining the original logical hostname for default certificate verification and SNI; mismatch failure and explicit setHostname override are covered. Generated-Haxe loopback snapshots exercise the same default endpoint path, TLS close_notify write shutdown, preserved reads, and explicit read-only rejection. Native POSIX evidence verifies inherited fast-send against the underlying TCP option. TLS remains experimental because public certificate stores, hostile peers, resource convergence, and runtime behavior outside Linux/amd64 are not admitted; Windows evidence is compile-only. |
### `go-native`
