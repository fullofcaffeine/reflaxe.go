...
Threading and synchronization surfaces pending lifecycle audit

| Symbol | Granularity | State | Release admitted | Evidence | Qualification |
| --- | --- | --- | --- | --- | --- |
| `sys.thread.Lock` | `surface` | `experimental` | no | `semantic:thread-primitives`, `bead:concurrency-audit` | Deterministic primitive tests exist, but race, visibility, generation, and wakeup closure remains open. |
| `sys.thread.Mutex` | `surface` | `experimental` | no | `semantic:thread-primitives`, `bead:concurrency-audit` | Deterministic primitive tests exist, but race, visibility, generation, and wakeup closure remains open. |
| `sys.thread.Condition` | `surface` | `experimental` | no | `semantic:thread-primitives`, `bead:concurrency-audit` | Deterministic primitive tests exist, but race, visibility, generation, and wakeup closure remains open. |
| `sys.thread.Semaphore` | `surface` | `experimental` | no | `semantic:thread-primitives`, `bead:concurrency-audit` | Deterministic primitive tests exist, but race, visibility, generation, and wakeup closure remains open. |
| `sys.thread.Deque` | `surface` | `experimental` | no | `semantic:thread-primitives`, `bead:concurrency-audit` | Deterministic primitive tests exist, but race, visibility, generation, and wakeup closure remains open. |
| `sys.thread.Tls` | `surface` | `experimental` | no | `semantic:thread-primitives`, `bead:concurrency-audit` | Deterministic primitive tests exist, but race, visibility, generation, and wakeup closure remains open. |
| `sys.thread.Thread` | `surface` | `experimental` | no | `semantic:thread-runtime`, `bead:concurrency-audit` | Schedule/run/shutdown and lifecycle smokes exist; stress, leak, missed-wakeup, and identity evidence remains open. |
| `sys.thread.EventLoop` | `surface` | `experimental` | no | `semantic:thread-runtime`, `bead:concurrency-audit` | Schedule/run/shutdown and lifecycle smokes exist; stress, leak, missed-wakeup, and identity evidence remains open. |
| `sys.thread.FixedThreadPool` | `surface` | `experimental` | no | `semantic:thread-runtime`, `bead:concurrency-audit` | Schedule/run/shutdown and lifecycle smokes exist; stress, leak, missed-wakeup, and identity evidence remains open. |
| `sys.thread.ElasticThreadPool` | `surface` | `experimental` | no | `semantic:thread-runtime`, `bead:concurrency-audit` | Schedule/run/shutdown and lifecycle smokes exist; stress, leak, missed-wakeup, and identity evidence remains open. |
### `portable-networking`
...
| `sys.net.Socket` | `surface` | `experimental` | no | `semantic:socket`, `bead:network-audit` | Loopback and target-sensitive smokes exist; cross-platform timeout, cancellation, TLS, and cleanup evidence remains open. |
| `sys.net.UdpSocket` | `surface` | `experimental` | no | `semantic:socket`, `bead:network-audit` | Loopback and target-sensitive smokes exist; cross-platform timeout, cancellation, TLS, and cleanup evidence remains open. |
| `sys.net.Host` | `surface` | `experimental` | no | `semantic:socket`, `bead:network-audit` | Loopback and target-sensitive smokes exist; cross-platform timeout, cancellation, TLS, and cleanup evidence remains open. |
| `sys.ssl.Socket` | `surface` | `experimental` | no | `semantic:socket`, `bead:network-audit` | Loopback and target-sensitive smokes exist; cross-platform timeout, cancellation, TLS, and cleanup evidence remains open. |
### `go-native`
...
| `go.Go` | `surface` | `experimental` | no | `snapshot:native-concurrency`, `bead:native-matrix` | Go-specific behavior is tested, but true native select and the public native capability contract remain open. |
| `go.Chan<T>` | `surface` | `experimental` | no | `snapshot:native-concurrency`, `bead:native-matrix` | Go-specific behavior is tested, but true native select and the public native capability contract remain open. |
| `go.Select` | `surface` | `experimental` | no | `snapshot:native-concurrency`, `bead:native-matrix` | Go-specific behavior is tested, but true native select and the public native capability contract remain open. |
...
| Bead | Scope | Blocks |
| --- | --- | --- |
| `haxe_go-vfp.10.2` | Concurrency race, visibility, wakeup, pool, cancellation, and goroutine-identity closure | portable-concurrency |
