...
- `haxe.go-14as.40`: kept native Go stack capture out of the portable semantic baseline and documented the future opt-in diagnostic design in `docs/spikes/native-stack-capture-contract.md`. Follow-up implementation is tracked by `haxe.go-14as.76`.
