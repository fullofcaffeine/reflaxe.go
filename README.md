...
The compiler and repository package are GPL-3.0-only. Programs generated by
`haxe.go` may use the application author's chosen license, including a
commercial or proprietary license. Project-owned runtime and generated support
portions use the separate generated-output MIT grant, and generated projects
