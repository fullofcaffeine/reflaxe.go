...
- `gopher`: Go-first authoring/output style without changing core semantic guarantees (includes safe literal string-op folding, typed String helper lowering, and safe leaf dispatch devirtualization for `self` plus tracked local aliases).
