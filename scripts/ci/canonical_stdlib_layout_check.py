...
def audit_package_map_manifest(package_root: Path, source_root: Path) -> list[Violation]:
    ...
    for source_path, kind in (
        ...
        ("README.md", "metadata"),
        ("docs/compatibility-release-status.md", "metadata"),
        ("docs/compatibility-support-manifest.json", "metadata"),
        ("docs/compatibility-support-matrix.md", "metadata"),
        ("docs/known-gaps.md", "metadata"),
        ("docs/release-readiness-checklist.md", "metadata"),
        ("docs/toolchain-policy.md", "metadata"),
