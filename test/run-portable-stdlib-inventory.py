...
MODULE_NOTES_OVERRIDES = {
    ...
    "haxe.Template": (
        ...
        "a staged std override in std/go/_std/haxe/Template.hx. Parsing, lookup, concrete and "
        "structural iteration, macros, errors, and rendering remain source-owned. Selective "
        "same-package compiler metadata supplies only already-bound lowercase generated methods "
        "to the generic Reflect.field/hasField path; three dynamic representation operations use "
        "the typed std/hxrt/template binding and footprint-explicit runtime/hxrt/template.go. "
        "Evidence: semantic_diff/haxe_template_contract, "
        "semantic_diff/haxe_template_concrete_iterable_contract, stdlib/haxe_template_basic, "
        "stdlib/haxe_template_generated_method_lookup, and runtime template tests."
    ),
    "haxe.crypto.Base64": (
