...
func (self *sys__io__FileOutput) writeBytes(bytes *haxe__io__Bytes, pos int, length int) int {
	...
	return hxrt.FileOutputWriteValues(self.handle, func(hx_lambda_raw_22 []any) []int {
		hx_lambda_out_23 := make([]int, 0, len(hx_lambda_raw_22))
		for _, hx_lambda_item_24 := range hx_lambda_raw_22 {
			hx_lambda_out_23 = append(hx_lambda_out_23, func(hx_value_25 any) int {
				if hx_value_25 == nil {
					var hx_zero_26 int
					return hx_zero_26
				}
