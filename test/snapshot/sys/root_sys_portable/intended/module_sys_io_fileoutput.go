...
func (self *sys__io__FileOutput) writeBytes(bytes *haxe__io__Bytes, pos int, length int) int {
	...
	return hxrt.FileOutputWriteValues(self.handle, func(hx_lambda_raw_57 []any) []int {
		hx_lambda_out_58 := make([]int, 0, len(hx_lambda_raw_57))
		for _, hx_lambda_item_59 := range hx_lambda_raw_57 {
			hx_lambda_out_58 = append(hx_lambda_out_58, func(hx_value_60 any) int {
				if hx_value_60 == nil {
					var hx_zero_61 int
					return hx_zero_61
				}
