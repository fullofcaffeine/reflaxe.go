...
func StringTools_hex(n int, digits any) *string {
	...
	hx_do_first_299 := true
	for hx_do_first_299 || (value > 0) {
		hx_do_first_299 = false
	...
	if digits == nil {
		...
		hx_if_300 = digits.(int)
	}
	resolvedDigits := hx_if_300
...
func StringTools_ltrim(s *string) *string {
	...
	var hx_if_303 *string
	if r > 0 {
		hx_if_303 = hxrt.StringSubstrStringPtr(s, r, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_303 = s
	}
	return hx_if_303
...
func StringTools_rtrim(s *string) *string {
	...
	var hx_if_305 *string
	if r > 0 {
		hx_if_305 = hxrt.StringSubstrStringPtr(s, 0, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_305 = s
	}
	return hx_if_305
