...
func (self *haxe__io__Input) readByte() int {
	return func() int {
		hxrt.Throw(New_haxe__exceptions__NotImplementedException(nil, nil, func() map[string]any {
			hx_obj_204 := map[string]any{}
			hx_obj_204["fileName"] = hxrt.StringFromLiteral("haxe/io/Input.hx")
			hx_obj_204["lineNumber"] = 18
			hx_obj_204["className"] = hxrt.StringFromLiteral("haxe.io.Input")
			hx_obj_204["methodName"] = hxrt.StringFromLiteral("readByte")
			return hx_obj_204
		}()))
		var hx_throw_zero_205 int
		return hx_throw_zero_205
	}()
}
...
func (self *haxe__io__Input) readAll(bufsize any) *haxe__io__Bytes {
	...
	hxrt.TryCatch(func() {
		...
		switch hx_typed_209 := hx_caught_208.(type) {
		case *haxe__io__Eof:
			hx_tmp := hx_typed_209
			_ = hx_tmp
		default:
			hxrt.Throw(hx_caught_208)
		}
	})
...
func (self *haxe__io__Input) readLine() *string {
	...
	hxrt.TryCatch(func() {
		...
		switch hx_typed_211 := hx_caught_210.(type) {
		case *haxe__io__Eof:
			error := hx_typed_211
			result = buffer.__hx_this.getBytes().__hx_this.toString()
...
func (self *haxe__io__Input) readDouble() float64 {
	...
	var hx_if_212 float64
	if self.bigEndian {
		hx_if_212 = haxe__io__FPHelper_i64ToDouble(second, first)
	} else {
		hx_if_212 = haxe__io__FPHelper_i64ToDouble(first, second)
	}
	return hx_if_212
}
...
func (self *haxe__io__Input) readInt8() int {
	...
	var hx_if_213 int
	if value >= 128 {
		hx_if_213 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(256))))
	} else {
		hx_if_213 = value
	}
	return hx_if_213
...
func (self *haxe__io__Input) readInt16() int {
	...
	var hx_if_214 int
	if self.bigEndian {
		hx_if_214 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_214 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	value := hx_if_214
	var hx_if_215 int
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(32768)))) != 0 {
		hx_if_215 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(65536))))
	} else {
		hx_if_215 = value
	}
	return hx_if_215
...
func (self *haxe__io__Input) readUInt16() int {
	...
	var hx_if_216 int
	if self.bigEndian {
		hx_if_216 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_216 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	return hx_if_216
}
...
func (self *haxe__io__Input) readInt24() int {
	...
	var hx_if_217 int
	if self.bigEndian {
		hx_if_217 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_217 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	value := hx_if_217
	var hx_if_218 int
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(8388608)))) != 0 {
		hx_if_218 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(16777216))))
	} else {
		hx_if_218 = value
	}
	return hx_if_218
...
func (self *haxe__io__Input) readUInt24() int {
	...
	var hx_if_219 int
	if self.bigEndian {
		hx_if_219 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_219 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	return hx_if_219
}
...
func (self *haxe__io__Input) readInt32() int {
	...
	var hx_if_220 int
	if self.bigEndian {
		hx_if_220 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(24))))))))
	} else {
		hx_if_220 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) << uint(24))))))))
	}
	return hx_if_220
}
