...
func (self *haxe__io__Input) readByte() int {
	return func() int {
		hxrt.Throw(New_haxe__exceptions__NotImplementedException(nil, nil, func() map[string]any {
			...
			hx_obj_184["fileName"] = hxrt.StringFromLiteral("haxe/io/Input.hx")
			hx_obj_184["lineNumber"] = 18
			hx_obj_184["className"] = hxrt.StringFromLiteral("haxe.io.Input")
			hx_obj_184["methodName"] = hxrt.StringFromLiteral("readByte")
			return hx_obj_184
		}()))
		var hx_throw_zero_185 int
		return hx_throw_zero_185
	}()
}
...
func (self *haxe__io__Input) readBytes(bytes *haxe__io__Bytes, pos int, len int) int {
	...
	}, func(hx_caught_186 any) {
		switch hx_typed_187 := hx_caught_186.(type) {
		case *haxe__io__Eof:
			hx_tmp := hx_typed_187
			_ = hx_tmp
		default:
			hxrt.Throw(hx_caught_186)
		}
	})
...
func (self *haxe__io__Input) readAll(bufsize any) *haxe__io__Bytes {
	...
	}, func(hx_caught_188 any) {
		switch hx_typed_189 := hx_caught_188.(type) {
		case *haxe__io__Eof:
			hx_tmp := hx_typed_189
			_ = hx_tmp
		default:
			hxrt.Throw(hx_caught_188)
		}
	})
...
func (self *haxe__io__Input) readLine() *string {
	...
	}, func(hx_caught_190 any) {
		switch hx_typed_191 := hx_caught_190.(type) {
		case *haxe__io__Eof:
			error := hx_typed_191
			result = buffer.__hx_this.getBytes().__hx_this.toString()
...
func (self *haxe__io__Input) readDouble() float64 {
	...
	var hx_if_192 float64
	if self.bigEndian {
		hx_if_192 = haxe__io__FPHelper_i64ToDouble(second, first)
	} else {
		hx_if_192 = haxe__io__FPHelper_i64ToDouble(first, second)
	}
	return hx_if_192
}
...
func (self *haxe__io__Input) readInt8() int {
	...
	var hx_if_193 int
	if value >= 128 {
		hx_if_193 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(256))))
	} else {
		hx_if_193 = value
	}
	return hx_if_193
...
func (self *haxe__io__Input) readInt16() int {
	...
	var hx_if_194 int
	if self.bigEndian {
		hx_if_194 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_194 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	value := hx_if_194
	var hx_if_195 int
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(32768)))) != 0 {
		hx_if_195 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(65536))))
	} else {
		hx_if_195 = value
	}
	return hx_if_195
...
func (self *haxe__io__Input) readUInt16() int {
	...
	var hx_if_196 int
	if self.bigEndian {
		hx_if_196 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_196 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	return hx_if_196
}
...
func (self *haxe__io__Input) readInt24() int {
	...
	var hx_if_197 int
	if self.bigEndian {
		hx_if_197 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_197 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	value := hx_if_197
	var hx_if_198 int
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(8388608)))) != 0 {
		hx_if_198 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(16777216))))
	} else {
		hx_if_198 = value
	}
	return hx_if_198
...
func (self *haxe__io__Input) readUInt24() int {
	...
	var hx_if_199 int
	if self.bigEndian {
		hx_if_199 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_199 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	return hx_if_199
}
...
func (self *haxe__io__Input) readInt32() int {
	...
	var hx_if_200 int
	if self.bigEndian {
		hx_if_200 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(24))))))))
	} else {
		hx_if_200 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) << uint(24))))))))
	}
	return hx_if_200
}
