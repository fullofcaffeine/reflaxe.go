...
func StringTools_hex(n int, digits any) *string {
	...
	hx_do_first_298 := true
	for hx_do_first_298 || (value > 0) {
		hx_do_first_298 = false
	...
	if digits == nil {
		...
		hx_if_299 = digits.(int)
	}
	resolvedDigits := hx_if_299
...
func StringTools_ltrim(s *string) *string {
	...
	var hx_if_302 *string
	if r > 0 {
		hx_if_302 = hxrt.StringSubstrStringPtr(s, r, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_302 = s
	}
	return hx_if_302
...
func StringTools_rtrim(s *string) *string {
	...
	var hx_if_304 *string
	if r > 0 {
		hx_if_304 = hxrt.StringSubstrStringPtr(s, 0, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_304 = s
	}
	return hx_if_304
