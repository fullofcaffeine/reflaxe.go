...
func (self *haxe__io__Output) writeByte(value int) {
	hxrt.Throw(New_haxe__exceptions__NotImplementedException(nil, nil, func() map[string]any {
		...
		hx_obj_172["fileName"] = hxrt.StringFromLiteral("haxe/io/Output.hx")
		hx_obj_172["lineNumber"] = 17
		hx_obj_172["className"] = hxrt.StringFromLiteral("haxe.io.Output")
		hx_obj_172["methodName"] = hxrt.StringFromLiteral("writeByte")
		return hx_obj_172
	}()))
}
...
func (self *haxe__io__Output) writeInput(input *haxe__io__Input, bufsize any) {
	...
	}, func(hx_caught_173 any) {
		switch hx_typed_174 := hx_caught_173.(type) {
		case *haxe__io__Eof:
			hx_tmp := hx_typed_174
			_ = hx_tmp
		default:
			hxrt.Throw(hx_caught_173)
		}
	})
}
