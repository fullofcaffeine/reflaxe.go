...
func (self *haxe__io__Output) writeByte(value int) {
	hxrt.Throw(New_haxe__exceptions__NotImplementedException(nil, nil, func() map[string]any {
		hx_obj_191 := map[string]any{}
		hx_obj_191["fileName"] = hxrt.StringFromLiteral("haxe/io/Output.hx")
		hx_obj_191["lineNumber"] = 17
		hx_obj_191["className"] = hxrt.StringFromLiteral("haxe.io.Output")
		hx_obj_191["methodName"] = hxrt.StringFromLiteral("writeByte")
		return hx_obj_191
	}()))
}
...
func (self *haxe__io__Output) writeInput(input *haxe__io__Input, bufsize any) {
	...
	hxrt.TryCatch(func() {
		...
		switch hx_typed_193 := hx_caught_192.(type) {
		case *haxe__io__Eof:
			hx_tmp := hx_typed_193
			_ = hx_tmp
		default:
			hxrt.Throw(hx_caught_192)
		}
	})
}
