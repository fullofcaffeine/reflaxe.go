...
func (self *haxe__io__Input) readByte() int {
	return func() int {
		hxrt.Throw(New_haxe__exceptions__NotImplementedException(nil, nil, func() map[string]any {
			hx_obj_194 := map[string]any{}
			hx_obj_194["fileName"] = hxrt.StringFromLiteral("haxe/io/Input.hx")
			hx_obj_194["lineNumber"] = 18
			hx_obj_194["className"] = hxrt.StringFromLiteral("haxe.io.Input")
			hx_obj_194["methodName"] = hxrt.StringFromLiteral("readByte")
			return hx_obj_194
		}()))
		var hx_throw_zero_195 int
...
func (self *haxe__io__Input) readAll(bufsize any) *haxe__io__Bytes {
	...
	}, func(hx_caught_198 any) {
		switch hx_typed_199 := hx_caught_198.(type) {
		case *haxe__io__Eof:
			hx_tmp := hx_typed_199
			_ = hx_tmp
		default:
			hxrt.Throw(hx_caught_198)
		}
	})
...
func (self *haxe__io__Input) readDouble() float64 {
	...
	var hx_if_202 float64
	if self.bigEndian {
		hx_if_202 = haxe__io__FPHelper_i64ToDouble(second, first)
	} else {
		hx_if_202 = haxe__io__FPHelper_i64ToDouble(first, second)
	}
	return hx_if_202
}
...
func (self *haxe__io__Input) readInt8() int {
	...
	var hx_if_203 int
	if value >= 128 {
		hx_if_203 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(256))))
	} else {
		hx_if_203 = value
	}
	return hx_if_203
...
func (self *haxe__io__Input) readInt16() int {
	...
	var hx_if_204 int
	if self.bigEndian {
		hx_if_204 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_204 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	value := hx_if_204
	var hx_if_205 int
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(32768)))) != 0 {
		hx_if_205 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(65536))))
	} else {
		hx_if_205 = value
	}
	return hx_if_205
...
func (self *haxe__io__Input) readUInt16() int {
	...
	var hx_if_206 int
	if self.bigEndian {
		hx_if_206 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_206 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	return hx_if_206
}
...
func (self *haxe__io__Input) readInt24() int {
	...
	var hx_if_207 int
	if self.bigEndian {
		hx_if_207 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_207 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	value := hx_if_207
	var hx_if_208 int
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(8388608)))) != 0 {
		hx_if_208 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(16777216))))
	} else {
		hx_if_208 = value
	}
	return hx_if_208
...
func (self *haxe__io__Input) readUInt24() int {
	...
	var hx_if_209 int
	if self.bigEndian {
		hx_if_209 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_209 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	return hx_if_209
}
...
func (self *haxe__io__Input) readInt32() int {
	...
	var hx_if_210 int
	if self.bigEndian {
		hx_if_210 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(24))))))))
	} else {
		hx_if_210 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) << uint(24))))))))
	}
	return hx_if_210
}
