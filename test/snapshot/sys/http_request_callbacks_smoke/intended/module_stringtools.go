...
func StringTools_hex(n int, digits any) *string {
	...
	hx_do_first_289 := true
	for hx_do_first_289 || (value > 0) {
		hx_do_first_289 = false
	...
	if digits == nil {
		...
		hx_if_290 = digits.(int)
	}
	resolvedDigits := hx_if_290
...
func StringTools_ltrim(s *string) *string {
	...
	var hx_if_293 *string
	if r > 0 {
		hx_if_293 = hxrt.StringSubstrStringPtr(s, r, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_293 = s
	}
	return hx_if_293
...
func StringTools_rtrim(s *string) *string {
	...
	var hx_if_295 *string
	if r > 0 {
		hx_if_295 = hxrt.StringSubstrStringPtr(s, 0, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_295 = s
	}
	return hx_if_295
