...
func StringTools_hex(n int, digits any) *string {
	...
	hx_do_first_315 := true
	for hx_do_first_315 || (value > 0) {
		hx_do_first_315 = false
	...
	if digits == nil {
		...
		hx_if_316 = digits.(int)
	}
	resolvedDigits := hx_if_316
...
func StringTools_ltrim(s *string) *string {
	...
	if r > 0 {
		hx_if_319 = hxrt.StringSubstrStringPtr(s, r, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_319 = s
	}
	return hx_if_319
...
func StringTools_rtrim(s *string) *string {
	...
	if r > 0 {
		hx_if_321 = hxrt.StringSubstrStringPtr(s, 0, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_321 = s
	}
	return hx_if_321
