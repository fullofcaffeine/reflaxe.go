...
func (self *haxe__io__Output) writeByte(value int) {
	hxrt.Throw(New_haxe__exceptions__NotImplementedException(nil, nil, func() map[string]any {
		...
		hx_obj_35["fileName"] = hxrt.StringFromLiteral("haxe/io/Output.hx")
		hx_obj_35["lineNumber"] = 17
		hx_obj_35["className"] = hxrt.StringFromLiteral("haxe.io.Output")
		hx_obj_35["methodName"] = hxrt.StringFromLiteral("writeByte")
		return hx_obj_35
	}()))
}
...
func (self *haxe__io__Output) writeInput(input *haxe__io__Input, bufsize any) {
	...
	}, func(hx_caught_36 any) {
		switch hx_typed_37 := hx_caught_36.(type) {
		case *haxe__io__Eof:
			hx_tmp := hx_typed_37
			_ = hx_tmp
		default:
			hxrt.Throw(hx_caught_36)
		}
	})
}
