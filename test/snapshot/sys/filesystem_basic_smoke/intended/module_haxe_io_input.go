...
func (self *haxe__io__Input) readByte() int {
	return func() int {
		hxrt.Throw(New_haxe__exceptions__NotImplementedException(nil, nil, func() map[string]any {
			...
			hx_obj_38["fileName"] = hxrt.StringFromLiteral("haxe/io/Input.hx")
			hx_obj_38["lineNumber"] = 18
			hx_obj_38["className"] = hxrt.StringFromLiteral("haxe.io.Input")
			hx_obj_38["methodName"] = hxrt.StringFromLiteral("readByte")
			return hx_obj_38
		}()))
		var hx_throw_zero_39 int
...
func (self *haxe__io__Input) readDouble() float64 {
	...
	if self.bigEndian {
		hx_if_46 = haxe__io__FPHelper_i64ToDouble(second, first)
	} else {
		hx_if_46 = haxe__io__FPHelper_i64ToDouble(first, second)
	}
	return hx_if_46
}
...
func (self *haxe__io__Input) readInt8() int {
	...
	var hx_if_47 int
	if value >= 128 {
		hx_if_47 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(256))))
	} else {
		hx_if_47 = value
	}
	return hx_if_47
...
func (self *haxe__io__Input) readInt16() int {
	...
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(32768)))) != 0 {
		hx_if_49 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(65536))))
	} else {
		hx_if_49 = value
	}
	return hx_if_49
...
func (self *haxe__io__Input) readUInt16() int {
	...
	var hx_if_50 int
	if self.bigEndian {
		hx_if_50 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_50 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	return hx_if_50
}
...
func (self *haxe__io__Input) readInt24() int {
	...
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(8388608)))) != 0 {
		hx_if_52 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(16777216))))
	} else {
		hx_if_52 = value
	}
	return hx_if_52
...
func (self *haxe__io__Input) readUInt24() int {
	...
	var hx_if_53 int
	if self.bigEndian {
		hx_if_53 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_53 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	return hx_if_53
}
...
func (self *haxe__io__Input) readInt32() int {
	...
	var hx_if_54 int
	if self.bigEndian {
		hx_if_54 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(24))))))))
	} else {
		hx_if_54 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) << uint(24))))))))
	}
	return hx_if_54
}
