...
func sys__FileSystem_stat(path *string) map[string]any {
	...
	hx_obj_17["gid"] = value.Gid
	hx_obj_17["uid"] = value.Uid
	hx_obj_17["atime"] = Date_fromTime(value.AtimeMs)
	hx_obj_17["mtime"] = Date_fromTime(value.MtimeMs)
	hx_obj_17["ctime"] = Date_fromTime(value.CtimeMs)
	hx_obj_17["size"] = value.Size
	hx_obj_17["dev"] = value.Dev
	hx_obj_17["ino"] = value.Ino
	hx_obj_17["nlink"] = value.Nlink
	hx_obj_17["rdev"] = value.Rdev
	hx_obj_17["mode"] = value.Mode
	return hx_obj_17
}
