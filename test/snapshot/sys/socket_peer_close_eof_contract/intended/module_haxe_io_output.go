...
func (self *haxe__io__Output) writeByte(value int) {
	hxrt.Throw(New_haxe__exceptions__NotImplementedException(nil, nil, func() map[string]any {
		...
		hx_obj_54["fileName"] = hxrt.StringFromLiteral("haxe/io/Output.hx")
		hx_obj_54["lineNumber"] = 17
		hx_obj_54["className"] = hxrt.StringFromLiteral("haxe.io.Output")
		hx_obj_54["methodName"] = hxrt.StringFromLiteral("writeByte")
		return hx_obj_54
	}()))
}
