...
func (self *haxe__io__Input) readByte() int {
	return func() int {
		hxrt.Throw(New_haxe__exceptions__NotImplementedException(nil, nil, func() map[string]any {
			...
			hx_obj_57["fileName"] = hxrt.StringFromLiteral("haxe/io/Input.hx")
			hx_obj_57["lineNumber"] = 18
			hx_obj_57["className"] = hxrt.StringFromLiteral("haxe.io.Input")
			hx_obj_57["methodName"] = hxrt.StringFromLiteral("readByte")
			return hx_obj_57
		}()))
...
func (self *haxe__io__Input) readBytes(bytes *haxe__io__Bytes, pos int, len int) int {
	...
	}, func(hx_caught_59 any) {
		switch hx_typed_60 := hx_caught_59.(type) {
		case *haxe__io__Eof:
			hx_tmp := hx_typed_60
			_ = hx_tmp
		default:
			hxrt.Throw(hx_caught_59)
		}
	})
...
func (self *haxe__io__Input) readAll(bufsize any) *haxe__io__Bytes {
	...
	}, func(hx_caught_61 any) {
		switch hx_typed_62 := hx_caught_61.(type) {
		case *haxe__io__Eof:
			hx_tmp := hx_typed_62
			_ = hx_tmp
		default:
			hxrt.Throw(hx_caught_61)
		}
	})
...
func (self *haxe__io__Input) readDouble() float64 {
	...
	var hx_if_65 float64
	if self.bigEndian {
		hx_if_65 = haxe__io__FPHelper_i64ToDouble(second, first)
	} else {
		hx_if_65 = haxe__io__FPHelper_i64ToDouble(first, second)
	}
	return hx_if_65
}
...
func (self *haxe__io__Input) readInt8() int {
	...
	var hx_if_66 int
	if value >= 128 {
		hx_if_66 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(256))))
	} else {
		hx_if_66 = value
	}
	return hx_if_66
...
func (self *haxe__io__Input) readInt16() int {
	...
	var hx_if_67 int
	if self.bigEndian {
		hx_if_67 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_67 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	value := hx_if_67
	var hx_if_68 int
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(32768)))) != 0 {
		hx_if_68 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(65536))))
	} else {
		hx_if_68 = value
	}
	return hx_if_68
...
func (self *haxe__io__Input) readUInt16() int {
	...
	var hx_if_69 int
	if self.bigEndian {
		hx_if_69 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_69 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	return hx_if_69
}
...
func (self *haxe__io__Input) readInt24() int {
	...
	var hx_if_70 int
	if self.bigEndian {
		hx_if_70 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_70 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	value := hx_if_70
	var hx_if_71 int
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(8388608)))) != 0 {
		hx_if_71 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(16777216))))
	} else {
		hx_if_71 = value
	}
	return hx_if_71
...
func (self *haxe__io__Input) readUInt24() int {
	...
	var hx_if_72 int
	if self.bigEndian {
		hx_if_72 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_72 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	return hx_if_72
}
...
func (self *haxe__io__Input) readInt32() int {
	...
	var hx_if_73 int
	if self.bigEndian {
		hx_if_73 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(24))))))))
	} else {
		hx_if_73 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) << uint(24))))))))
	}
	return hx_if_73
}
