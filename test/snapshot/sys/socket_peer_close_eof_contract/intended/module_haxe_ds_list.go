...
func (self *haxe__ds___List__GoListKeyValueIterator) next() map[string]any {
	...
	key := hx_post_85
	hx_obj_86 := map[string]any{}
	hx_obj_86["key"] = key
	hx_obj_86["value"] = self.items.Get(key)
	return hx_obj_86
}
...
func (self *haxe__ds___List__GoListIterator) next() any {
	hx_post_87 := self.index
	self.index = int(int32((self.index + 1)))
	return self.items.Get(hx_post_87)
}
...
func (self *haxe__ds__List) last() any {
	...
	if self.length == 0 {
		...
		hx_if_91 = self.items.Get(int(int32((hxrt.Int32Wrap(self.length) - hxrt.Int32Wrap(1)))))
	}
	return hx_if_91
}
...
func (self *haxe__ds__List) filter(predicate func(any) bool) *haxe__ds__List {
	...
	source := func(hx_value_101 any) *haxe__ds___List__GoListIterator {
		if hx_value_101 == nil {
			var hx_zero_102 *haxe__ds___List__GoListIterator
			return hx_zero_102
		}
		return hx_value_101.(*haxe__ds___List__GoListIterator)
	}(self.__hx_this.iterator())
	for func(hx_value_103 any) bool {
		if hx_value_103 == nil {
...
func (self *haxe__ds__List) map_(transform func(any) any) *haxe__ds__List {
	...
	source := func(hx_value_105 any) *haxe__ds___List__GoListIterator {
		if hx_value_105 == nil {
			var hx_zero_106 *haxe__ds___List__GoListIterator
			return hx_zero_106
		}
		return hx_value_105.(*haxe__ds___List__GoListIterator)
	}(self.__hx_this.iterator())
	for func(hx_value_107 any) bool {
		if hx_value_107 == nil {
