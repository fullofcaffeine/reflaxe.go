...
func (self *haxe__io__Input) readByte() int {
	return func() int {
		hxrt.Throw(New_haxe__exceptions__NotImplementedException(nil, nil, func() map[string]any {
			...
			hx_obj_318["fileName"] = hxrt.StringFromLiteral("haxe/io/Input.hx")
			hx_obj_318["lineNumber"] = 18
			hx_obj_318["className"] = hxrt.StringFromLiteral("haxe.io.Input")
			hx_obj_318["methodName"] = hxrt.StringFromLiteral("readByte")
			return hx_obj_318
		}()))
		var hx_throw_zero_319 int
		return hx_throw_zero_319
	}()
}
...
func (self *haxe__io__Input) readBytes(bytes *haxe__io__Bytes, pos int, len int) int {
	...
	}, func(hx_caught_320 any) {
		switch hx_typed_321 := hx_caught_320.(type) {
		case *haxe__io__Eof:
			hx_tmp := hx_typed_321
			_ = hx_tmp
		default:
			hxrt.Throw(hx_caught_320)
		}
	})
...
func (self *haxe__io__Input) readAll(bufsize any) *haxe__io__Bytes {
	...
	}, func(hx_caught_322 any) {
		switch hx_typed_323 := hx_caught_322.(type) {
		case *haxe__io__Eof:
			hx_tmp := hx_typed_323
			_ = hx_tmp
		default:
			hxrt.Throw(hx_caught_322)
		}
	})
...
func (self *haxe__io__Input) readLine() *string {
	...
	}, func(hx_caught_324 any) {
		switch hx_typed_325 := hx_caught_324.(type) {
		case *haxe__io__Eof:
			error := hx_typed_325
			result = buffer.__hx_this.getBytes().__hx_this.toString()
...
func (self *haxe__io__Input) readDouble() float64 {
	...
	var hx_if_326 float64
	if self.bigEndian {
		hx_if_326 = haxe__io__FPHelper_i64ToDouble(second, first)
	} else {
		hx_if_326 = haxe__io__FPHelper_i64ToDouble(first, second)
	}
	return hx_if_326
}
...
func (self *haxe__io__Input) readInt8() int {
	...
	var hx_if_327 int
	if value >= 128 {
		hx_if_327 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(256))))
	} else {
		hx_if_327 = value
	}
	return hx_if_327
...
func (self *haxe__io__Input) readInt16() int {
	...
	var hx_if_328 int
	if self.bigEndian {
		hx_if_328 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_328 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	value := hx_if_328
	var hx_if_329 int
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(32768)))) != 0 {
		hx_if_329 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(65536))))
	} else {
		hx_if_329 = value
	}
	return hx_if_329
...
func (self *haxe__io__Input) readUInt16() int {
	...
	var hx_if_330 int
	if self.bigEndian {
		hx_if_330 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_330 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	return hx_if_330
}
...
func (self *haxe__io__Input) readInt24() int {
	...
	var hx_if_331 int
	if self.bigEndian {
		hx_if_331 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_331 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	value := hx_if_331
	var hx_if_332 int
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(8388608)))) != 0 {
		hx_if_332 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(16777216))))
	} else {
		hx_if_332 = value
	}
	return hx_if_332
...
func (self *haxe__io__Input) readUInt24() int {
	...
	var hx_if_333 int
	if self.bigEndian {
		hx_if_333 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_333 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	return hx_if_333
}
...
func (self *haxe__io__Input) readInt32() int {
	...
	var hx_if_334 int
	if self.bigEndian {
		hx_if_334 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(24))))))))
	} else {
		hx_if_334 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) << uint(24))))))))
	}
	return hx_if_334
}
