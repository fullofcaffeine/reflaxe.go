...
func Std_downcast(value any, c any) any {
	...
	if func(hx_value any, hx_type any) bool {
		...
		case *hxrt__TypeClassValue:
			...
			case "_Main.TrackingInput":
				return func(hx_value any) bool {
					switch hx_carrier := hx_value.(type) {
					case *_Main__TrackingInput:
						if hx_carrier == nil {
							return false
						}
						return true
					case *haxe__io__Input:
						...
						_, hx_ok := hx_carrier.__hx_this.(*_Main__TrackingInput)
						return hx_ok
					default:
						return false
					}
			...
			case "haxe.io.BytesOutput":
				return func(hx_value any) bool {
					...
					case *haxe__io__Output:
						...
						_, hx_ok := hx_carrier.__hx_this.(*haxe__io__BytesOutput)
						return hx_ok
					default:
						return false
					}
			...
			case "sys.Http":
				return func(hx_value any) bool {
					...
					case *haxe__http__HttpBase:
						...
						_, hx_ok := hx_carrier.__hx_this.(*sys__Http)
						return hx_ok
					case *sys__Http:
						if hx_carrier == nil {
							return false
			...
			case "sys.io._Process.ProcessInput":
				return func(hx_value any) bool {
					...
					case *haxe__io__Output:
						...
						_, hx_ok := hx_carrier.__hx_this.(*sys__io___Process__ProcessInput)
						return hx_ok
					case *sys__io___Process__ProcessInput:
						if hx_carrier == nil {
							return false
			...
			case "sys.io._Process.ProcessOutput":
				return func(hx_value any) bool {
					...
					case *haxe__io__Input:
						...
						_, hx_ok := hx_carrier.__hx_this.(*sys__io___Process__ProcessOutput)
						return hx_ok
					case *sys__io___Process__ProcessOutput:
						if hx_carrier == nil {
							return false
...
func Std_parseInt(x *string) any {
	...
	if hexadecimal {
		...
		for index < length {
			...
			if (code_1 >= 48) && (code_1 <= 57) {
				hx_if_424 = int(int32((hxrt.Int32Wrap(code_1) - hxrt.Int32Wrap(48))))
			} else {
				var hx_if_423 int
				if (code_1 >= 97) && (code_1 <= 102) {
					hx_if_423 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(code_1) - hxrt.Int32Wrap(97))))) + hxrt.Int32Wrap(10))))
				} else {
					var hx_if_422 int
					if (code_1 >= 65) && (code_1 <= 70) {
						hx_if_422 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(code_1) - hxrt.Int32Wrap(65))))) + hxrt.Int32Wrap(10))))
					} else {
						hx_if_422 = -1
					}
					hx_if_423 = hx_if_422
		...
		var hx_if_425 any
		if negative {
			hx_if_425 = int(int32(-int32(value)))
		} else {
			hx_if_425 = value
		}
		return hx_if_425
	...
	for index < length {
		...
		if (code_2 >= 48) && (code_2 <= 57) {
			hx_if_426 = int(int32((hxrt.Int32Wrap(code_2) - hxrt.Int32Wrap(48))))
		} else {
			hx_if_426 = -1
		}
		digit_1 := hx_if_426
	...
	if negative {
		...
		hx_if_428 = int(int32(-int32(result)))
	}
	return hx_if_428
}
