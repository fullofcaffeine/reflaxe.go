...
func StringTools_hex(n int, digits any) *string {
	...
	hx_do_first_442 := true
	for hx_do_first_442 || (value > 0) {
		hx_do_first_442 = false
	...
	if digits == nil {
		...
		hx_if_443 = digits.(int)
	}
	resolvedDigits := hx_if_443
...
func StringTools_ltrim(s *string) *string {
	...
	var hx_if_446 *string
	if r > 0 {
		hx_if_446 = hxrt.StringSubstrStringPtr(s, r, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_446 = s
	}
	return hx_if_446
...
func StringTools_rtrim(s *string) *string {
	...
	var hx_if_448 *string
	if r > 0 {
		hx_if_448 = hxrt.StringSubstrStringPtr(s, 0, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_448 = s
	}
	return hx_if_448
