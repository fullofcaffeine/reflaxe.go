...
func Std_parseInt(x *string) any {
	...
	if hexadecimal {
		...
		for index < length {
			...
			if (code_1 >= 48) && (code_1 <= 57) {
				hx_if_74 = int(int32((hxrt.Int32Wrap(code_1) - hxrt.Int32Wrap(48))))
			} else {
				var hx_if_73 int
				if (code_1 >= 97) && (code_1 <= 102) {
					hx_if_73 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(code_1) - hxrt.Int32Wrap(97))))) + hxrt.Int32Wrap(10))))
				} else {
					var hx_if_72 int
					if (code_1 >= 65) && (code_1 <= 70) {
						hx_if_72 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(code_1) - hxrt.Int32Wrap(65))))) + hxrt.Int32Wrap(10))))
					} else {
						hx_if_72 = -1
					}
					hx_if_73 = hx_if_72
		...
		var hx_if_75 any
		if negative {
			hx_if_75 = int(int32(-int32(value)))
		} else {
			hx_if_75 = value
		}
		return hx_if_75
	...
	for index < length {
		...
		if (code_2 >= 48) && (code_2 <= 57) {
			hx_if_76 = int(int32((hxrt.Int32Wrap(code_2) - hxrt.Int32Wrap(48))))
		} else {
			hx_if_76 = -1
		}
		digit_1 := hx_if_76
	...
	if negative {
		...
		hx_if_78 = int(int32(-int32(result)))
	}
	return hx_if_78
}
