...
func (self *haxe__io__Input) readByte() int {
	return func() int {
		hxrt.Throw(New_haxe__exceptions__NotImplementedException(nil, nil, func() map[string]any {
			...
			hx_obj_36["fileName"] = hxrt.StringFromLiteral("haxe/io/Input.hx")
			hx_obj_36["lineNumber"] = 18
			hx_obj_36["className"] = hxrt.StringFromLiteral("haxe.io.Input")
			hx_obj_36["methodName"] = hxrt.StringFromLiteral("readByte")
			return hx_obj_36
		}()))
...
func (self *haxe__io__Input) readBytes(bytes *haxe__io__Bytes, pos int, len int) int {
	...
	hxrt.TryCatch(func() {
		...
		switch hx_typed_39 := hx_caught_38.(type) {
		case *haxe__io__Eof:
			hx_tmp := hx_typed_39
			_ = hx_tmp
		default:
			hxrt.Throw(hx_caught_38)
		}
	})
...
func (self *haxe__io__Input) readAll(bufsize any) *haxe__io__Bytes {
	...
	hxrt.TryCatch(func() {
		...
		switch hx_typed_41 := hx_caught_40.(type) {
		case *haxe__io__Eof:
			hx_tmp := hx_typed_41
			_ = hx_tmp
		default:
			hxrt.Throw(hx_caught_40)
		}
	})
...
func (self *haxe__io__Input) readLine() *string {
	...
	}, func(hx_caught_42 any) {
		switch hx_typed_43 := hx_caught_42.(type) {
		case *haxe__io__Eof:
			error := hx_typed_43
			result = buffer.__hx_this.getBytes().__hx_this.toString()
...
func (self *haxe__io__Input) readDouble() float64 {
	...
	var hx_if_44 float64
	if self.bigEndian {
		hx_if_44 = haxe__io__FPHelper_i64ToDouble(second, first)
	} else {
		hx_if_44 = haxe__io__FPHelper_i64ToDouble(first, second)
	}
	return hx_if_44
}
...
func (self *haxe__io__Input) readInt8() int {
	...
	var hx_if_45 int
	if value >= 128 {
		hx_if_45 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(256))))
	} else {
		hx_if_45 = value
	}
	return hx_if_45
...
func (self *haxe__io__Input) readInt16() int {
	...
	var hx_if_46 int
	if self.bigEndian {
		hx_if_46 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_46 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	value := hx_if_46
	var hx_if_47 int
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(32768)))) != 0 {
		hx_if_47 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(65536))))
	} else {
		hx_if_47 = value
	}
	return hx_if_47
...
func (self *haxe__io__Input) readUInt16() int {
	...
	var hx_if_48 int
	if self.bigEndian {
		hx_if_48 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_48 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	return hx_if_48
}
...
func (self *haxe__io__Input) readInt24() int {
	...
	var hx_if_49 int
	if self.bigEndian {
		hx_if_49 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_49 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	value := hx_if_49
	var hx_if_50 int
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(8388608)))) != 0 {
		hx_if_50 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(16777216))))
	} else {
		hx_if_50 = value
	}
	return hx_if_50
...
func (self *haxe__io__Input) readUInt24() int {
	...
	var hx_if_51 int
	if self.bigEndian {
		hx_if_51 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_51 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	return hx_if_51
}
...
func (self *haxe__io__Input) readInt32() int {
	...
	var hx_if_52 int
	if self.bigEndian {
		hx_if_52 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(24))))))))
	} else {
		hx_if_52 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) << uint(24))))))))
	}
	return hx_if_52
}
