...
func (self *haxe__io__Output) writeByte(value int) {
	hxrt.Throw(New_haxe__exceptions__NotImplementedException(nil, nil, func() map[string]any {
		...
		hx_obj_177["fileName"] = hxrt.StringFromLiteral("haxe/io/Output.hx")
		hx_obj_177["lineNumber"] = 17
		hx_obj_177["className"] = hxrt.StringFromLiteral("haxe.io.Output")
		hx_obj_177["methodName"] = hxrt.StringFromLiteral("writeByte")
		return hx_obj_177
	}()))
}
...
func (self *haxe__io__Output) writeInput(input *haxe__io__Input, bufsize any) {
	...
	}, func(hx_caught_178 any) {
		switch hx_typed_179 := hx_caught_178.(type) {
		case *haxe__io__Eof:
			hx_tmp := hx_typed_179
			_ = hx_tmp
		default:
			hxrt.Throw(hx_caught_178)
		}
	})
}
