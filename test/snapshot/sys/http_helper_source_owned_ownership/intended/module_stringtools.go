...
func StringTools_hex(n int, digits any) *string {
	...
	hx_do_first_294 := true
	for hx_do_first_294 || (value > 0) {
		hx_do_first_294 = false
	...
	if digits == nil {
		...
		hx_if_295 = digits.(int)
	}
	resolvedDigits := hx_if_295
...
func StringTools_ltrim(s *string) *string {
	...
	var hx_if_298 *string
	if r > 0 {
		hx_if_298 = hxrt.StringSubstrStringPtr(s, r, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_298 = s
	}
	return hx_if_298
...
func StringTools_rtrim(s *string) *string {
	...
	if r > 0 {
		hx_if_300 = hxrt.StringSubstrStringPtr(s, 0, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_300 = s
	}
	return hx_if_300
