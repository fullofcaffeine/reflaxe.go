...
func (self *haxe__io__Input) readByte() int {
	return func() int {
		hxrt.Throw(New_haxe__exceptions__NotImplementedException(nil, nil, func() map[string]any {
			...
			hx_obj_40["fileName"] = hxrt.StringFromLiteral("haxe/io/Input.hx")
			hx_obj_40["lineNumber"] = 18
			hx_obj_40["className"] = hxrt.StringFromLiteral("haxe.io.Input")
			hx_obj_40["methodName"] = hxrt.StringFromLiteral("readByte")
			return hx_obj_40
		}()))
...
func (self *haxe__io__Input) readDouble() float64 {
	...
	var hx_if_48 float64
	if self.bigEndian {
		hx_if_48 = haxe__io__FPHelper_i64ToDouble(second, first)
	} else {
		hx_if_48 = haxe__io__FPHelper_i64ToDouble(first, second)
	}
	return hx_if_48
}
...
func (self *haxe__io__Input) readInt8() int {
	...
	var hx_if_49 int
	if value >= 128 {
		hx_if_49 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(256))))
	} else {
		hx_if_49 = value
	}
	return hx_if_49
...
func (self *haxe__io__Input) readInt16() int {
	...
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(32768)))) != 0 {
		hx_if_51 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(65536))))
	} else {
		hx_if_51 = value
	}
	return hx_if_51
...
func (self *haxe__io__Input) readInt24() int {
	...
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(8388608)))) != 0 {
		hx_if_54 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(16777216))))
	} else {
		hx_if_54 = value
	}
	return hx_if_54
...
func (self *haxe__io__Input) readInt32() int {
	...
	var hx_if_56 int
	if self.bigEndian {
		hx_if_56 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(24))))))))
	} else {
		hx_if_56 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) << uint(24))))))))
	}
	return hx_if_56
}
