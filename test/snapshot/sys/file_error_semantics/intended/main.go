...
func main() {
	...
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("missing.read.throws="), hxrt.StdString(throws(func() {
		sys__io__File_getContent(hxrt.StringConcatStringPtr(root, hxrt.StringFromLiteral("/missing.txt")))
	}))))
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("directory.read.throws="), hxrt.StdString(throws(func() {
		sys__io__File_getContent(root)
	}))))
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("directory.write.throws="), hxrt.StdString(throws(func() {
		sys__io__File_saveContent(root, hxrt.StringFromLiteral("not-a-file"))
	}))))
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("environment.invalid.throws="), hxrt.StdString(throws(func() {
		Sys_putEnv(hxrt.StringFromLiteral("HAXE_GO=INVALID"), hxrt.StringFromLiteral("value"))
	}))))
	...
	Sys_command(hxrt.StringFromLiteral("chmod"), []*string{hxrt.StringFromLiteral("000"), locked})
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("permission.read.throws="), hxrt.StdString(throws(func() {
		sys__io__File_getContent(locked)
	}))))
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("permission.write.throws="), hxrt.StdString(throws(func() {
		sys__io__File_saveContent(locked, hxrt.StringFromLiteral("replacement"))
	}))))
	Sys_command(hxrt.StringFromLiteral("chmod"), []*string{hxrt.StringFromLiteral("600"), locked})
...
func Sys_command(command *string, args []*string) int {
	return hxrt.SysCommand(command, args)
}
...
func Type_getClassFields(c any) []*string {
	...
	switch className {
	case "Main":
		return []*string{hxrt.StringFromLiteral("main"), hxrt.StringFromLiteral("throws")}
	case "haxe.Int64Helper":
		return []*string{}
	case "haxe._Int32.Int32_Impl_":
		return []*string{}
