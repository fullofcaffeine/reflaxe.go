...
func (self *haxe__io__Input) readByte() int {
	return func() int {
		hxrt.Throw(New_haxe__exceptions__NotImplementedException(nil, nil, func() map[string]any {
			...
			hx_obj_78["fileName"] = hxrt.StringFromLiteral("haxe/io/Input.hx")
			hx_obj_78["lineNumber"] = 18
			hx_obj_78["className"] = hxrt.StringFromLiteral("haxe.io.Input")
			hx_obj_78["methodName"] = hxrt.StringFromLiteral("readByte")
			return hx_obj_78
		}()))
		var hx_throw_zero_79 int
		return hx_throw_zero_79
	}()
}
...
func (self *haxe__io__Input) readBytes(bytes *haxe__io__Bytes, pos int, len int) int {
	...
	hxrt.TryCatch(func() {
		...
		switch hx_typed_81 := hx_caught_80.(type) {
		case *haxe__io__Eof:
			hx_tmp := hx_typed_81
			_ = hx_tmp
		default:
			hxrt.Throw(hx_caught_80)
		}
	})
...
func (self *haxe__io__Input) readLine() *string {
	...
	}, func(hx_caught_84 any) {
		switch hx_typed_85 := hx_caught_84.(type) {
		case *haxe__io__Eof:
			error := hx_typed_85
			result = buffer.__hx_this.getBytes().__hx_this.toString()
...
func (self *haxe__io__Input) readDouble() float64 {
	...
	var hx_if_86 float64
	if self.bigEndian {
		hx_if_86 = haxe__io__FPHelper_i64ToDouble(second, first)
	} else {
		hx_if_86 = haxe__io__FPHelper_i64ToDouble(first, second)
	}
	return hx_if_86
}
...
func (self *haxe__io__Input) readInt8() int {
	...
	var hx_if_87 int
	if value >= 128 {
		hx_if_87 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(256))))
	} else {
		hx_if_87 = value
	}
	return hx_if_87
...
func (self *haxe__io__Input) readInt16() int {
	...
	var hx_if_88 int
	if self.bigEndian {
		hx_if_88 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_88 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	value := hx_if_88
	var hx_if_89 int
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(32768)))) != 0 {
		hx_if_89 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(65536))))
	} else {
		hx_if_89 = value
	}
	return hx_if_89
...
func (self *haxe__io__Input) readUInt16() int {
	...
	var hx_if_90 int
	if self.bigEndian {
		hx_if_90 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_90 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	return hx_if_90
}
...
func (self *haxe__io__Input) readInt24() int {
	...
	var hx_if_91 int
	if self.bigEndian {
		hx_if_91 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_91 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	value := hx_if_91
	var hx_if_92 int
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(8388608)))) != 0 {
		hx_if_92 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(16777216))))
	} else {
		hx_if_92 = value
	}
	return hx_if_92
...
func (self *haxe__io__Input) readUInt24() int {
	...
	var hx_if_93 int
	if self.bigEndian {
		hx_if_93 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_93 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	return hx_if_93
}
...
func (self *haxe__io__Input) readInt32() int {
	...
	var hx_if_94 int
	if self.bigEndian {
		hx_if_94 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(24))))))))
	} else {
		hx_if_94 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) << uint(24))))))))
	}
	return hx_if_94
}
