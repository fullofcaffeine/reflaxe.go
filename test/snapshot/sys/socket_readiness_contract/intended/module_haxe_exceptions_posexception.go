...
func New_haxe__exceptions__PosException(message *string, previous *hxrt.ExceptionValue, pos map[string]any) *haxe__exceptions__PosException {
	...
	if pos == nil {
		...
		hx_obj_106["fileName"] = hxrt.StringFromLiteral("(unknown)")
		hx_obj_106["lineNumber"] = 0
		hx_obj_106["className"] = hxrt.StringFromLiteral("(unknown)")
		hx_obj_106["methodName"] = hxrt.StringFromLiteral("(unknown)")
		self.posInfos = hx_obj_106
	} else {
		self.posInfos = pos
	}
	return self
...
func (self *haxe__exceptions__PosException) toString() *string {
	return hxrt.StringConcatAny(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.ExceptionMessage(self), hxrt.StringFromLiteral(" in ")), func(hx_obj_107 map[string]any) *string {
		hx_field_108 := hx_obj_107["className"]
		if hx_field_108 == nil {
			var hx_zero_109 *string
			return hx_zero_109
		}
		return hx_field_108.(*string)
	}(self.posInfos)), hxrt.StringFromLiteral(".")), func(hx_obj_110 map[string]any) *string {
		hx_field_111 := hx_obj_110["methodName"]
		if hx_field_111 == nil {
			var hx_zero_112 *string
			return hx_zero_112
		}
		return hx_field_111.(*string)
	}(self.posInfos)), hxrt.StringFromLiteral(" at ")), func(hx_obj_113 map[string]any) *string {
		hx_field_114 := hx_obj_113["fileName"]
		if hx_field_114 == nil {
			var hx_zero_115 *string
			return hx_zero_115
		}
		return hx_field_114.(*string)
	}(self.posInfos)), hxrt.StringFromLiteral(":")), func(hx_obj_116 map[string]any) int {
		hx_field_117 := hx_obj_116["lineNumber"]
		if hx_field_117 == nil {
			var hx_zero_118 int
			return hx_zero_118
		}
