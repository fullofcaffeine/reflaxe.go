...
func (self *haxe__io__Input) readByte() int {
	return func() int {
		hxrt.Throw(New_haxe__exceptions__NotImplementedException(nil, nil, func() map[string]any {
			...
			hx_obj_19["fileName"] = hxrt.StringFromLiteral("haxe/io/Input.hx")
			hx_obj_19["lineNumber"] = 18
			hx_obj_19["className"] = hxrt.StringFromLiteral("haxe.io.Input")
			hx_obj_19["methodName"] = hxrt.StringFromLiteral("readByte")
			return hx_obj_19
		}()))
		var hx_throw_zero_20 int
...
func (self *haxe__io__Input) readBytes(bytes *haxe__io__Bytes, pos int, len int) int {
	...
	}, func(hx_caught_21 any) {
		switch hx_typed_22 := hx_caught_21.(type) {
		case *haxe__io__Eof:
			hx_tmp := hx_typed_22
			_ = hx_tmp
		default:
			hxrt.Throw(hx_caught_21)
		}
	})
...
func (self *haxe__io__Input) readAll(bufsize any) *haxe__io__Bytes {
	...
	}, func(hx_caught_23 any) {
		switch hx_typed_24 := hx_caught_23.(type) {
		case *haxe__io__Eof:
			hx_tmp := hx_typed_24
			_ = hx_tmp
		default:
			hxrt.Throw(hx_caught_23)
		}
	})
...
func (self *haxe__io__Input) readLine() *string {
	...
	}, func(hx_caught_25 any) {
		switch hx_typed_26 := hx_caught_25.(type) {
		case *haxe__io__Eof:
			error := hx_typed_26
			result = buffer.__hx_this.getBytes().__hx_this.toString()
...
func (self *haxe__io__Input) readDouble() float64 {
	...
	var hx_if_27 float64
	if self.bigEndian {
		hx_if_27 = haxe__io__FPHelper_i64ToDouble(second, first)
	} else {
		hx_if_27 = haxe__io__FPHelper_i64ToDouble(first, second)
	}
	return hx_if_27
}
...
func (self *haxe__io__Input) readInt8() int {
	...
	var hx_if_28 int
	if value >= 128 {
		hx_if_28 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(256))))
	} else {
		hx_if_28 = value
	}
	return hx_if_28
...
func (self *haxe__io__Input) readInt16() int {
	...
	var hx_if_29 int
	if self.bigEndian {
		hx_if_29 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_29 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	value := hx_if_29
	var hx_if_30 int
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(32768)))) != 0 {
		hx_if_30 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(65536))))
	} else {
		hx_if_30 = value
	}
	return hx_if_30
...
func (self *haxe__io__Input) readUInt16() int {
	...
	var hx_if_31 int
	if self.bigEndian {
		hx_if_31 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_31 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	return hx_if_31
}
...
func (self *haxe__io__Input) readInt24() int {
	...
	var hx_if_32 int
	if self.bigEndian {
		hx_if_32 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_32 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	value := hx_if_32
	var hx_if_33 int
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(8388608)))) != 0 {
		hx_if_33 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(16777216))))
	} else {
		hx_if_33 = value
	}
	return hx_if_33
...
func (self *haxe__io__Input) readUInt24() int {
	...
	var hx_if_34 int
	if self.bigEndian {
		hx_if_34 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_34 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	return hx_if_34
}
...
func (self *haxe__io__Input) readInt32() int {
	...
	var hx_if_35 int
	if self.bigEndian {
		hx_if_35 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(24))))))))
	} else {
		hx_if_35 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) << uint(24))))))))
	}
	return hx_if_35
}
