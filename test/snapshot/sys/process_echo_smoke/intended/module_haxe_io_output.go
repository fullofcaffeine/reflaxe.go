...
func (self *haxe__io__Output) writeByte(value int) {
	hxrt.Throw(New_haxe__exceptions__NotImplementedException(nil, nil, func() map[string]any {
		...
		hx_obj_16["fileName"] = hxrt.StringFromLiteral("haxe/io/Output.hx")
		hx_obj_16["lineNumber"] = 17
		hx_obj_16["className"] = hxrt.StringFromLiteral("haxe.io.Output")
		hx_obj_16["methodName"] = hxrt.StringFromLiteral("writeByte")
		return hx_obj_16
	}()))
}
