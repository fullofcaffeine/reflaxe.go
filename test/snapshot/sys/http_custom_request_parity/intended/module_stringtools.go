...
func StringTools_hex(n int, digits any) *string {
	...
	hx_do_first_321 := true
	for hx_do_first_321 || (value > 0) {
		hx_do_first_321 = false
	...
	if digits == nil {
		...
		hx_if_322 = digits.(int)
	}
	resolvedDigits := hx_if_322
...
func StringTools_ltrim(s *string) *string {
	...
	var hx_if_325 *string
	if r > 0 {
		hx_if_325 = hxrt.StringSubstrStringPtr(s, r, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_325 = s
	}
	return hx_if_325
...
func StringTools_rtrim(s *string) *string {
	...
	var hx_if_327 *string
	if r > 0 {
		hx_if_327 = hxrt.StringSubstrStringPtr(s, 0, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_327 = s
	}
	return hx_if_327
