...
func (self *haxe__http__HttpBase) setHeader(name *string, value *string) {
	...
	for _g < _g1 {
		...
		_g = int(int32((_g + 1)))
		i := hx_post_14
		if hxrt.StringEqualStringPtr(func(hx_obj_15 map[string]any) *string {
			hx_field_16 := hx_obj_15["name"]
			if hx_field_16 == nil {
