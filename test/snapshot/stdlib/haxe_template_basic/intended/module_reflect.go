...
func Reflect_fields(o any) *hxrt.Array {
	...
	return hxrt.ArrayFromValues(func(hx_sort_src_272 []*string) []any {
		hx_sort_out_274 := make([]any, 0, len(hx_sort_src_272))
		for _, hx_sort_item_273 := range hx_sort_src_272 {
			hx_sort_out_274 = append(hx_sort_out_274, hx_sort_item_273)
		}
		return hx_sort_out_274
...
func Reflect_getProperty(o any, field *string) any {
	...
	if hxrt.AnyEqualsNull(getter) {
		hx_if_275 = Reflect_field(o, field)
	} else {
		hx_if_275 = Reflect_callMethod(o, getter, hxrt.NewArray())
	}
	return hx_if_275
}
