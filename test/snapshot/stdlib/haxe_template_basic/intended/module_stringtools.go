...
func StringTools_hex(n int, digits any) *string {
	...
	hx_do_first_264 := true
	for hx_do_first_264 || (value > 0) {
		hx_do_first_264 = false
	...
	if digits == nil {
		...
		hx_if_265 = digits.(int)
	}
	resolvedDigits := hx_if_265
...
func StringTools_ltrim(s *string) *string {
	...
	var hx_if_268 *string
	if r > 0 {
		hx_if_268 = hxrt.StringSubstrStringPtr(s, r, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_268 = s
	}
	return hx_if_268
...
func StringTools_rtrim(s *string) *string {
	...
	var hx_if_270 *string
	if r > 0 {
		hx_if_270 = hxrt.StringSubstrStringPtr(s, 0, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_270 = s
	}
	return hx_if_270
