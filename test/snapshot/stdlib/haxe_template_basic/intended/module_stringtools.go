...
func StringTools_hex(n int, digits any) *string {
	...
	hx_do_first_256 := true
	for hx_do_first_256 || (value > 0) {
		hx_do_first_256 = false
	...
	if digits == nil {
		...
		hx_if_257 = digits.(int)
	}
	resolvedDigits := hx_if_257
...
func StringTools_ltrim(s *string) *string {
	...
	var hx_if_260 *string
	if r > 0 {
		hx_if_260 = hxrt.StringSubstrStringPtr(s, r, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_260 = s
	}
	return hx_if_260
...
func StringTools_rtrim(s *string) *string {
	...
	var hx_if_262 *string
	if r > 0 {
		hx_if_262 = hxrt.StringSubstrStringPtr(s, 0, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_262 = s
	}
	return hx_if_262
