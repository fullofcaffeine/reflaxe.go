...
func (self *haxe__ds__StringMap) keyValueIterator() map[string]any {
	...
	hx_obj_246["next"] = func() map[string]any {
		...
		hx_obj_253["key"] = key
		hx_obj_253["value"] = _gthis.get(key)
		return hx_obj_253
	}
	return hx_obj_246
}
...
func (self *haxe__ds__StringMap) getIMap(key any) any {
	return self.get(hxrt.StdString(func(hx_value_254 any) *string {
		if hx_value_254 == nil {
...
func (self *haxe__ds__StringMap) setIMap(key any, value any) {
	self.set(hxrt.StdString(func(hx_value_256 any) *string {
		if hx_value_256 == nil {
...
func (self *haxe__ds__StringMap) existsIMap(key any) bool {
	...
	}(self.exists(hxrt.StdString(func(hx_value_258 any) *string {
		if hx_value_258 == nil {
...
func (self *haxe__ds__StringMap) removeIMap(key any) bool {
	...
	}(self.remove(hxrt.StdString(func(hx_value_262 any) *string {
		if hx_value_262 == nil {
