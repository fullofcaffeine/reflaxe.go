...
func haxe___CallStack__CallStack_Impl__callStack() *hxrt.Array {
	return haxe__NativeStackTrace_toHaxe(haxe__NativeStackTrace_callStack(), 1)
}
...
func haxe___CallStack__CallStack_Impl__exceptionStack(fullStack bool) *hxrt.Array {
	return haxe__NativeStackTrace_toHaxe(haxe__NativeStackTrace_exceptionStack(), func() int {
		var hx_if_1 int
		if fullStack {
			hx_if_1 = 0
		} else {
...
func haxe___CallStack__CallStack_Impl__get(this1 *hxrt.Array, index int) *haxe__StackItem {
	return func(hx_value_2 any) *haxe__StackItem {
		if hx_value_2 == nil {
			var hx_zero_3 *haxe__StackItem
			return hx_zero_3
		}
		return hx_value_2.(*haxe__StackItem)
	}(this1.Get(index))
}
...
func haxe___CallStack__CallStack_Impl__itemToString(item *haxe__StackItem) *string {
	...
	switch item.tag {
	case 0:
		hx_switch_4 = hxrt.StringFromLiteral("a C function")
	case 1:
		_g := item.params[0].(*string)
		m := _g
		hx_switch_4 = hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("module "), m)
	case 2:
		...
		if inner == nil {
			...
			hx_if_5 = hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(haxe___CallStack__CallStack_Impl__itemToString(inner), hxrt.StringFromLiteral(" (")), file)
		}
		rendered := hx_if_5
		...
		hx_switch_4 = rendered
	case 3:
		_g_2 := item.params[0].(*string)
		_g1_1 := item.params[1].(*string)
		classname := _g_2
		method := _g1_1
		hx_switch_4 = hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(func() *string {
			var hx_if_6 *string
			if hxrt.StringEqualStringPtr(classname, nil) {
				hx_if_6 = hxrt.StringFromLiteral("<unknown>")
			} else {
				hx_if_6 = classname
			}
			return hx_if_6
	...
	case 4:
		...
		var v any = _g_3
		hx_switch_4 = hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("local function #"), hxrt.StdString(v))
	}
	return hx_switch_4
}
...
func haxe___CallStack__CallStack_Impl__toString(stack any) *string {
	...
	_g := 0
	_g1 := func(hx_value_7 any) *hxrt.Array {
		if hx_value_7 == nil {
			var hx_zero_8 *hxrt.Array
			return hx_zero_8
		}
		return hx_value_7.(*hxrt.Array)
	}(stack)
	for _g < _g1.Len() {
		item := func(hx_value_9 any) *haxe__StackItem {
			if hx_value_9 == nil {
				var hx_zero_10 *haxe__StackItem
				return hx_zero_10
			}
			return hx_value_9.(*haxe__StackItem)
		}(_g1.Get(_g))
		_g = int(int32((_g + 1)))
