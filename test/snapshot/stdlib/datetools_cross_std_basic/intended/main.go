...
func Type_getClassFields(c any) []*string {
	...
	switch className {
	case "DateTools":
		return []*string{hxrt.StringFromLiteral("DAYS_OF_MONTH"), hxrt.StringFromLiteral("DAY_NAMES"), hxrt.StringFromLiteral("DAY_SHORT_NAMES"), hxrt.StringFromLiteral("MONTH_NAMES"), hxrt.StringFromLiteral("MONTH_SHORT_NAMES"), hxrt.StringFromLiteral("__format"), hxrt.StringFromLiteral("__format_get"), hxrt.StringFromLiteral("days"), hxrt.StringFromLiteral("delta"), hxrt.StringFromLiteral("format"), hxrt.StringFromLiteral("getMonthDays"), hxrt.StringFromLiteral("hours"), hxrt.StringFromLiteral("make"), hxrt.StringFromLiteral("minutes"), hxrt.StringFromLiteral("parse"), hxrt.StringFromLiteral("seconds")}
	case "Main":
