...
func StringTools_fastCodeAt(s *string, index int) int {
	...
	if c == nil {
		...
		hx_if_42 = hxrt.IntFromNullableAny(c)
	}
	return hx_if_42
}
...
func StringTools_hex(n int, digits any) *string {
	...
	hx_do_first_43 := true
	for hx_do_first_43 || (value > 0) {
		hx_do_first_43 = false
	...
	if digits == nil {
		...
		hx_if_44 = hxrt.IntFromNullableAny(digits.(int))
	}
	resolvedDigits := hx_if_44
...
func StringTools_hexDigitValue(value *string) int {
	...
	if c == nil {
		...
		hx_if_45 = hxrt.IntFromNullableAny(c)
	}
	code := hx_if_45
	if code == -1 {
		return -1
...
func StringTools_isSpace(s *string, pos int) bool {
	...
	if c_1 == nil {
		...
		hx_if_46 = hxrt.IntFromNullableAny(c_1)
	}
	c := hx_if_46
...
func StringTools_ltrim(s *string) *string {
	...
	var hx_if_47 *string
	if r > 0 {
		hx_if_47 = hxrt.StringSubstrStringPtr(s, r, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_47 = s
	}
	return hx_if_47
...
func StringTools_rtrim(s *string) *string {
	...
	var hx_if_49 *string
	if r > 0 {
		hx_if_49 = hxrt.StringSubstrStringPtr(s, 0, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_49 = s
	}
	return hx_if_49
...
func StringTools_unsafeCodeAt(s *string, index int) int {
	...
	if c == nil {
		...
		hx_if_50 = hxrt.IntFromNullableAny(c)
	}
	return hx_if_50
}
...
func StringTools_utf16CodePointAt(s *string, index int) int {
	...
	if c_1 == nil {
		...
		hx_if_56 = hxrt.IntFromNullableAny(c_1)
	}
	c := hx_if_56
	if (c >= 55296) && (c <= 56319) {
		c = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(c) - hxrt.Int32Wrap(55232))))) << uint(10))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(func() int {
			...
			if c_2 == nil {
				...
				hx_if_57 = hxrt.IntFromNullableAny(c_2)
			}
			return hx_if_57
		}()) & hxrt.Int32Wrap(1023))))))))
	}
