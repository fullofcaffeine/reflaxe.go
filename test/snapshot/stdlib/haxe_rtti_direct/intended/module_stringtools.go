...
func StringTools_hex(n int, digits any) *string {
	...
	hx_do_first_878 := true
	for hx_do_first_878 || (value > 0) {
		hx_do_first_878 = false
	...
	if digits == nil {
		...
		hx_if_879 = digits.(int)
	}
	resolvedDigits := hx_if_879
...
func StringTools_ltrim(s *string) *string {
	...
	var hx_if_882 *string
	if r > 0 {
		hx_if_882 = hxrt.StringSubstrStringPtr(s, r, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_882 = s
	}
	return hx_if_882
...
func StringTools_rtrim(s *string) *string {
	...
	var hx_if_884 *string
	if r > 0 {
		hx_if_884 = hxrt.StringSubstrStringPtr(s, 0, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_884 = s
	}
	return hx_if_884
