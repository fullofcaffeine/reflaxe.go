...
func StringTools_hex(n int, digits any) *string {
	...
	hx_do_first_862 := true
	for hx_do_first_862 || (value > 0) {
		hx_do_first_862 = false
	...
	if digits == nil {
		...
		hx_if_863 = digits.(int)
	}
	resolvedDigits := hx_if_863
...
func StringTools_ltrim(s *string) *string {
	...
	if r > 0 {
		hx_if_866 = hxrt.StringSubstrStringPtr(s, r, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_866 = s
	}
	return hx_if_866
...
func StringTools_rtrim(s *string) *string {
	...
	var hx_if_868 *string
	if r > 0 {
		hx_if_868 = hxrt.StringSubstrStringPtr(s, 0, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_868 = s
	}
	return hx_if_868
