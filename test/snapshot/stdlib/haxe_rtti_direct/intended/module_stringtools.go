...
func StringTools_hex(n int, digits any) *string {
	...
	hx_do_first_844 := true
	for hx_do_first_844 || (value > 0) {
		hx_do_first_844 = false
	...
	if digits == nil {
		...
		hx_if_845 = digits.(int)
	}
	resolvedDigits := hx_if_845
...
func StringTools_ltrim(s *string) *string {
	...
	if r > 0 {
		hx_if_848 = hxrt.StringSubstrStringPtr(s, r, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_848 = s
	}
	return hx_if_848
...
func StringTools_rtrim(s *string) *string {
	...
	var hx_if_850 *string
	if r > 0 {
		hx_if_850 = hxrt.StringSubstrStringPtr(s, 0, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_850 = s
	}
	return hx_if_850
