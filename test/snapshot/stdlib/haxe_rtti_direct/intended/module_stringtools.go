...
func StringTools_hex(n int, digits any) *string {
	...
	hx_do_first_883 := true
	for hx_do_first_883 || (value > 0) {
		hx_do_first_883 = false
	...
	if digits == nil {
		...
		hx_if_884 = digits.(int)
	}
	resolvedDigits := hx_if_884
...
func StringTools_ltrim(s *string) *string {
	...
	var hx_if_887 *string
	if r > 0 {
		hx_if_887 = hxrt.StringSubstrStringPtr(s, r, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_887 = s
	}
	return hx_if_887
...
func StringTools_rtrim(s *string) *string {
	...
	var hx_if_889 *string
	if r > 0 {
		hx_if_889 = hxrt.StringSubstrStringPtr(s, 0, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_889 = s
	}
	return hx_if_889
