...
func haxe__xml__Parser_doParse(str *string, strict bool, p int, parent *Xml) int {
	...
	for p < hxrt.StringLengthStringPtr(str) {
		...
		case 2:
			...
			case 47:
				if parent == nil {
					...
					var hx_throw_zero_823 int
					return hx_throw_zero_823
				}
				start = int(int32((hxrt.Int32Wrap(p) + hxrt.Int32Wrap(1))))
				state = any(0)
				next = any(10)
		...
		case 3:
			if !((((((((c >= 97) && (c <= 122)) || ((c >= 65) && (c <= 90))) || ((c >= 48) && (c <= 57))) || (c == 58)) || (c == 46)) || (c == 95)) || (c == 45)) {
				if p == start {
					hxrt.Throw(New_haxe__xml__XmlParserException(hxrt.StringFromLiteral("Expected node name"), str, p))
					var hx_throw_zero_824 int
					return hx_throw_zero_824
				}
		...
		case 7:
			...
			default:
				hxrt.Throw(New_haxe__xml__XmlParserException(hxrt.StringFromLiteral("Expected \""), str, p))
				var hx_throw_zero_828 int
				return hx_throw_zero_828
			}
		case 8:
			switch c {
			case 38:
				var len any = int(int32((hxrt.Int32Wrap(p) - hxrt.Int32Wrap(start))))
				var hx_if_829 *string
				if len == nil {
					hx_if_829 = hxrt.StringSubstrStringPtr(str, start, 0, false)
				} else {
					hx_if_829 = hxrt.StringSubstrStringPtr(str, start, len.(int), true)
				}
				buf.b = hxrt.StringConcatStringPtr(buf.b, hx_if_829)
				state = any(18)
				escapeNext = any(8)
				start = int(int32((hxrt.Int32Wrap(p) + hxrt.Int32Wrap(1))))
			case 60, 62:
				if strict {
					...
					var hx_throw_zero_830 int
					return hx_throw_zero_830
				} else {
					if c == attrValQuote {
						var len_1 any = int(int32((hxrt.Int32Wrap(p) - hxrt.Int32Wrap(start))))
						var hx_if_831 *string
						if len_1 == nil {
							hx_if_831 = hxrt.StringSubstrStringPtr(str, start, 0, false)
						} else {
							hx_if_831 = hxrt.StringSubstrStringPtr(str, start, len_1.(int), true)
						}
						buf.b = hxrt.StringConcatStringPtr(buf.b, hx_if_831)
						val := buf.b
						buf = New_StringBuf()
						xml.set(aname, val)
						state = any(0)
			...
			default:
				if c == attrValQuote {
					...
					var hx_if_832 *string
					if len_2 == nil {
						hx_if_832 = hxrt.StringSubstrStringPtr(str, start, 0, false)
					} else {
						hx_if_832 = hxrt.StringSubstrStringPtr(str, start, len_2.(int), true)
					}
					buf.b = hxrt.StringConcatStringPtr(buf.b, hx_if_832)
					val_1 := buf.b
					buf = New_StringBuf()
					xml.set(aname, val_1)
					state = any(0)
		...
		case 13:
			if c == 60 {
				...
				if len_3 == nil {
					...
					hx_if_838 = hxrt.StringSubstrStringPtr(str, start, len_3.(int), true)
				}
				...
				if c == 38 {
					...
					if len_4 == nil {
						...
						hx_if_839 = hxrt.StringSubstrStringPtr(str, start, len_4.(int), true)
					}
			...
			if c == 59 {
				...
				if func() int {
					...
					if func() int {
						...
						hx_if_846 = hxrt.StdParseInt(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("0"), hxrt.StringSubstrStringPtr(s, 1, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s))-hxrt.Int32Wrap(1)))), true)))
					} else {
						hx_if_846 = hxrt.StdParseInt(hxrt.StringSubstrStringPtr(s, 1, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(1)))), true))
					}
					var c_12 any = hx_if_846
					c_14 := hxrt.IntFromNullableAny(c_12)
					buf.b = hxrt.StringConcatStringPtr(buf.b, hxrt.StringFromCharCode(c_14))
				} else {
					if !func(hx_value_850 any) bool {
						if hx_value_850 == nil {
							var hx_zero_851 bool
							return hx_zero_851
						}
						return hx_value_850.(bool)
						...
						x := func(hx_value_848 any) *string {
							if hx_value_848 == nil {
								var hx_zero_849 *string
								return hx_zero_849
							}
							return hx_value_848.(*string)
				...
				if !((((((((c >= 97) && (c <= 122)) || ((c >= 65) && (c <= 90))) || ((c >= 48) && (c <= 57))) || (c == 58)) || (c == 46)) || (c == 95)) || (c == 45)) && (c != 35) {
					if strict {
						...
						var hx_throw_zero_853 int
						return hx_throw_zero_853
					}
					...
					var hx_if_854 *string
					if len_5 == nil {
						hx_if_854 = hxrt.StringSubstrStringPtr(str, start, 0, false)
					} else {
						hx_if_854 = hxrt.StringSubstrStringPtr(str, start, len_5.(int), true)
					}
					buf.b = hxrt.StringConcatStringPtr(buf.b, hx_if_854)
					p = int(int32((p - 1)))
					start = int(int32((hxrt.Int32Wrap(p) + hxrt.Int32Wrap(1))))
					state = escapeNext
				}
	...
	if state == any(13) {
		if parent.nodeType == any(0) {
			...
			var hx_throw_zero_855 int
			return hx_throw_zero_855
		}
		if (p != start) || (nsubs == 0) {
			var len_6 any = int(int32((hxrt.Int32Wrap(p) - hxrt.Int32Wrap(start))))
			var hx_if_856 *string
			if len_6 == nil {
				hx_if_856 = hxrt.StringSubstrStringPtr(str, start, 0, false)
			} else {
				hx_if_856 = hxrt.StringSubstrStringPtr(str, start, len_6.(int), true)
			}
			buf.b = hxrt.StringConcatStringPtr(buf.b, hx_if_856)
	...
	if (!strict && (state == any(18))) && (escapeNext == any(13)) {
		...
		var hx_if_857 *string
		if len_7 == nil {
			hx_if_857 = hxrt.StringSubstrStringPtr(str, start, 0, false)
		} else {
			hx_if_857 = hxrt.StringSubstrStringPtr(str, start, len_7.(int), true)
		}
		buf.b = hxrt.StringConcatStringPtr(buf.b, hx_if_857)
	...
	var hx_throw_zero_858 int
	return hx_throw_zero_858
}
