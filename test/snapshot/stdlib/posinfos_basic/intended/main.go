...
func probe(label *string, pos map[string]any) {
	var v any = any(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(label, hxrt.StringFromLiteral(".class=")), func(hx_obj_3 map[string]any) *string {
	...
	hxrt.Println(v)
	var v_1 any = any(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(label, hxrt.StringFromLiteral(".method=")), func(hx_obj_6 map[string]any) *string {
	...
	hxrt.Println(v_1)
	var v_2 any = any(hxrt.StringConcatAny(hxrt.StringConcatStringPtr(label, hxrt.StringFromLiteral(".line=")), func(hx_obj_9 map[string]any) int {
	...
	hxrt.Println(v_2)
	var v_3 any = any(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(label, hxrt.StringFromLiteral(".fileNonEmpty=")), hxrt.StdString(!hxrt.StringEqualStringPtr(func(hx_obj_12 map[string]any) *string {
