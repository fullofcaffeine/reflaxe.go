...
func probe(label *string, pos map[string]any) {
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(label, hxrt.StringFromLiteral(".class=")), func(hx_obj_3 map[string]any) *string {
	...
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(label, hxrt.StringFromLiteral(".method=")), func(hx_obj_6 map[string]any) *string {
	...
	hxrt.Println(hxrt.StringConcatAny(hxrt.StringConcatStringPtr(label, hxrt.StringFromLiteral(".line=")), func(hx_obj_9 map[string]any) int {
	...
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(label, hxrt.StringFromLiteral(".fileNonEmpty=")), hxrt.StdString(!hxrt.StringEqualStringPtr(func(hx_obj_12 map[string]any) *string {
