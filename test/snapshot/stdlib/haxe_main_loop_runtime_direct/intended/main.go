...
func hxrt_typeCreateClassInstance(className string, args []any) (any, bool) {
	...
	case "haxe.Int64Helper":
		return nil, false
	case "haxe.MainEvent":
		return hxrt_typeCallAny(New_haxe__MainEvent, args)
	case "haxe.MainLoop":
		return nil, false
	case "haxe.Timer":
		return hxrt_typeCallAny(New_haxe__Timer, args)
...
func hxrt_typeCreateClassEmptyInstance(className string) (any, bool) {
	switch className {
	case "haxe.MainEvent":
		return &haxe__MainEvent{}, true
	case "haxe.Timer":
		return &haxe__Timer{}, true
	case "haxe._Int64.___Int64":
...
func Type_getClass(o any) any {
	...
	case hxrt__TypeClassValue:
		copyValue := value
		return &copyValue
	case *haxe__MainEvent:
		if value == nil {
			return nil
		}
		return &hxrt__TypeClassValue{name: hxrt.StringFromLiteral("haxe.MainEvent")}
	case *haxe__Timer:
		if value == nil {
			return nil
		}
		return &hxrt__TypeClassValue{name: hxrt.StringFromLiteral("haxe.Timer")}
...
func Type_getClassFields(c any) []*string {
	...
	case "haxe.EntryPoint":
		return []*string{hxrt.StringFromLiteral("addThread"), hxrt.StringFromLiteral("mainThread"), hxrt.StringFromLiteral("mutex"), hxrt.StringFromLiteral("run"), hxrt.StringFromLiteral("runInMainThread"), hxrt.StringFromLiteral("threadCount"), hxrt.StringFromLiteral("wakeup")}
	case "haxe.Int64Helper":
		return []*string{}
	case "haxe.MainEvent":
		return []*string{}
	case "haxe.MainLoop":
		return []*string{hxrt.StringFromLiteral("__remove"), hxrt.StringFromLiteral("add"), hxrt.StringFromLiteral("addThread"), hxrt.StringFromLiteral("get_threadCount"), hxrt.StringFromLiteral("hasEvents"), hxrt.StringFromLiteral("pending"), hxrt.StringFromLiteral("runInMainThread"), hxrt.StringFromLiteral("threadCount")}
	case "haxe.Timer":
		return []*string{hxrt.StringFromLiteral("delay"), hxrt.StringFromLiteral("measure"), hxrt.StringFromLiteral("stamp")}
	case "haxe._Int32.Int32_Impl_":
		return []*string{}
	case "haxe._Int64.Int64_Impl_":
		return []*string{}
...
func Type_getInstanceFields(c any) []*string {
	...
	case "haxe.Int64Helper":
		return []*string{}
	case "haxe.MainEvent":
		return []*string{hxrt.StringFromLiteral("active"), hxrt.StringFromLiteral("call"), hxrt.StringFromLiteral("delay"), hxrt.StringFromLiteral("delayNow"), hxrt.StringFromLiteral("dispatch"), hxrt.StringFromLiteral("f"), hxrt.StringFromLiteral("isBlocking"), hxrt.StringFromLiteral("nextRun"), hxrt.StringFromLiteral("priority"), hxrt.StringFromLiteral("schedule"), hxrt.StringFromLiteral("stop"), hxrt.StringFromLiteral("timer")}
	case "haxe.MainLoop":
		return []*string{}
	case "haxe.Timer":
		return []*string{hxrt.StringFromLiteral("eventHandler"), hxrt.StringFromLiteral("run"), hxrt.StringFromLiteral("stop"), hxrt.StringFromLiteral("thread")}
	case "haxe._Int32.Int32_Impl_":
		return []*string{}
	case "haxe._Int64.Int64_Impl_":
		return []*string{}
