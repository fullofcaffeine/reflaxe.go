...
func main() {
	...
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("cert.cn="), cert.get_commonName()))
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("cert.subject.cn="), cert.subject(hxrt.StringFromLiteral("CN"))))
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("cert.issuer.cn="), cert.issuer(hxrt.StringFromLiteral("CN"))))
	hxrt.Println(hxrt.StringConcatAny(hxrt.StringFromLiteral("cert.altNames="), len(cert.get_altNames())))
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("cert.next="), hxrt.StdString((cert.next() == nil))))
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("digest.sha256="), sys__ssl__Digest_make(payload, any(hxrt.StringFromLiteral("SHA256"))).toHex()))
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("digest.sha512="), sys__ssl__Digest_make(payload, any(hxrt.StringFromLiteral("SHA512"))).toHex()))
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("digest.verify="), hxrt.StdString(sys__ssl__Digest_verify(payload, sig, key, any(hxrt.StringFromLiteral("SHA256"))))))
}
