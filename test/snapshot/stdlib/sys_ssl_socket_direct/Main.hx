...
class Main {
	...
	static function main() {
		...
		Sys.println("server.accept.ssl=" + Std.isOfType(accepted, Socket));
		client.output.writeString("ping\n");
		client.output.flush();
		Sys.println("server.read=" + accepted.input.readLine());
		accepted.output.writeString("pong\n");
		...
		Sys.println("peer.next=" + (peer.next() == null));
