...
func New_haxe__exceptions__PosException(message *string, previous *hxrt.ExceptionValue, pos map[string]any) *haxe__exceptions__PosException {
	...
	if pos == nil {
		...
		hx_obj_129["fileName"] = hxrt.StringFromLiteral("(unknown)")
		hx_obj_129["lineNumber"] = 0
		hx_obj_129["className"] = hxrt.StringFromLiteral("(unknown)")
		hx_obj_129["methodName"] = hxrt.StringFromLiteral("(unknown)")
		self.posInfos = hx_obj_129
	} else {
		self.posInfos = pos
	}
	return self
...
func (self *haxe__exceptions__PosException) toString() *string {
	return hxrt.StringConcatAny(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.ExceptionMessage(self), hxrt.StringFromLiteral(" in ")), func(hx_obj_130 map[string]any) *string {
		hx_field_131 := hx_obj_130["className"]
		if hx_field_131 == nil {
			var hx_zero_132 *string
			return hx_zero_132
		}
		return hx_field_131.(*string)
	}(self.posInfos)), hxrt.StringFromLiteral(".")), func(hx_obj_133 map[string]any) *string {
		hx_field_134 := hx_obj_133["methodName"]
		if hx_field_134 == nil {
			var hx_zero_135 *string
			return hx_zero_135
		}
		return hx_field_134.(*string)
	}(self.posInfos)), hxrt.StringFromLiteral(" at ")), func(hx_obj_136 map[string]any) *string {
		hx_field_137 := hx_obj_136["fileName"]
		if hx_field_137 == nil {
			var hx_zero_138 *string
			return hx_zero_138
		}
		return hx_field_137.(*string)
	}(self.posInfos)), hxrt.StringFromLiteral(":")), func(hx_obj_139 map[string]any) int {
		hx_field_140 := hx_obj_139["lineNumber"]
		if hx_field_140 == nil {
			var hx_zero_141 int
			return hx_zero_141
		}
		return hx_field_140.(int)
	}(self.posInfos))
}
