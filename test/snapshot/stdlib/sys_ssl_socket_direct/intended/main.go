...
func main() {
	...
	client.output.flush()
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("server.read="), accepted.input.readLine()))
	accepted.output.writeString(hxrt.StringFromLiteral("pong\n"))
	accepted.output.flush()
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("client.read="), client.input.readLine()))
	peer := client.peerCertificate()
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("peer.cn="), peer.get_commonName()))
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("peer.issuer.cn="), peer.issuer(hxrt.StringFromLiteral("CN"))))
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("peer.next="), hxrt.StdString((peer.next() == nil))))
	client.close()
	accepted.close()
	server.close()
}
