...
func main() {
	...
	addr.host = host.ip
	addr.port = 3210
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("snapshot.host="), addr.getHost().toString()))
	hxrt.Println(hxrt.StringConcatAny(hxrt.StringFromLiteral("snapshot.compare="), addr.compare(addr.clone())))
	hxrt.Println(hxrt.StringConcatAny(hxrt.StringConcatStringPtr(hxrt.StringConcatAny(hxrt.StringConcatStringPtr(hxrt.StringConcatAny(hxrt.StringFromLiteral("snapshot.alg="), any(hxrt.StringFromLiteral("SHA224"))), hxrt.StringFromLiteral(",")), any(hxrt.StringFromLiteral("SHA384"))), hxrt.StringFromLiteral(",")), any(hxrt.StringFromLiteral("RIPEMD160"))))
}
