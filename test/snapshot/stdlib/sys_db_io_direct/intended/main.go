...
func main() {
	...
	output.writeString(hxrt.StringFromLiteral("ok"))
	output.seek(0, sys__io__FileSeek_SeekBegin)
	output.writeByte(79)
	output.close()
...
func Sys_environment() *haxe__ds__StringMap {
	env := New_haxe__ds__StringMap()
	for key, value := range hxrt.SysEnvironment() {
		env.h[key] = hxrt.StringFromLiteral(value)
	}
	return env
}
...
func hxrt_typeCreateClassInstance(className string, args []any) (any, bool) {
	...
	case "_Main.SnapConnection":
		return hxrt_typeCallAny(New__Main__SnapConnection, args)
	case "_Main.SnapResultSet":
		return hxrt_typeCallAny(New__Main__SnapResultSet, args)
	case "_Main.SnapRow":
		return hxrt_typeCallAny(New__Main__SnapRow, args)
	case "haxe.Int64Helper":
		return nil, false
	case "haxe._Constraints.Constructible_Impl_":
		return nil, false
	case "haxe._Constraints.FlatEnum_Impl_":
		return nil, false
	case "haxe._Constraints.Function_Impl_":
		return nil, false
	case "haxe._Constraints.NotVoid_Impl_":
		return nil, false
...
func hxrt_typeCreateClassEmptyInstance(className string) (any, bool) {
	...
	case "_Main.SnapConnection":
		return &_Main__SnapConnection{}, true
	case "_Main.SnapResultSet":
		return &_Main__SnapResultSet{}, true
	case "_Main.SnapRow":
		return &_Main__SnapRow{}, true
	case "haxe._Int64.___Int64":
...
func Type_getClass(o any) any {
	...
	case *_Main__SnapConnection:
		if value == nil {
			return nil
		}
		return &hxrt__TypeClassValue{name: hxrt.StringFromLiteral("_Main.SnapConnection")}
	case *_Main__SnapResultSet:
		if value == nil {
			return nil
		}
		return &hxrt__TypeClassValue{name: hxrt.StringFromLiteral("_Main.SnapResultSet")}
	case *_Main__SnapRow:
		if value == nil {
			return nil
		}
		return &hxrt__TypeClassValue{name: hxrt.StringFromLiteral("_Main.SnapRow")}
...
func Type_getClassFields(c any) []*string {
	...
	case "sys.db.Sqlite":
		return []*string{hxrt.StringFromLiteral("open")}
	default:
		return []*string{}
	}
}
...
func Type_getInstanceFields(c any) []*string {
	...
	case "_Main.SnapConnection":
		return []*string{hxrt.StringFromLiteral("addValue"), hxrt.StringFromLiteral("close"), hxrt.StringFromLiteral("commit"), hxrt.StringFromLiteral("dbName"), hxrt.StringFromLiteral("escape"), hxrt.StringFromLiteral("lastInsertId"), hxrt.StringFromLiteral("quote"), hxrt.StringFromLiteral("request"), hxrt.StringFromLiteral("rollback"), hxrt.StringFromLiteral("startTransaction")}
	case "_Main.SnapResultSet":
		return []*string{hxrt.StringFromLiteral("getFieldsNames"), hxrt.StringFromLiteral("getFloatResult"), hxrt.StringFromLiteral("getIntResult"), hxrt.StringFromLiteral("getResult"), hxrt.StringFromLiteral("get_length"), hxrt.StringFromLiteral("get_nfields"), hxrt.StringFromLiteral("hasNext"), hxrt.StringFromLiteral("index"), hxrt.StringFromLiteral("length"), hxrt.StringFromLiteral("next"), hxrt.StringFromLiteral("nfields"), hxrt.StringFromLiteral("results"), hxrt.StringFromLiteral("rows")}
	case "_Main.SnapRow":
		return []*string{hxrt.StringFromLiteral("value")}
	case "haxe.Int64Helper":
		return []*string{}
