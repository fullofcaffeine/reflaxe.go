...
func New_haxe__exceptions__PosException(message *string, previous *hxrt.ExceptionValue, pos map[string]any) *haxe__exceptions__PosException {
	...
	if pos == nil {
		...
		hx_obj_19["fileName"] = hxrt.StringFromLiteral("(unknown)")
		hx_obj_19["lineNumber"] = 0
		hx_obj_19["className"] = hxrt.StringFromLiteral("(unknown)")
		hx_obj_19["methodName"] = hxrt.StringFromLiteral("(unknown)")
		self.posInfos = hx_obj_19
	} else {
		self.posInfos = pos
	}
	return self
...
func (self *haxe__exceptions__PosException) toString() *string {
	return hxrt.StringConcatAny(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.ExceptionMessage(self), hxrt.StringFromLiteral(" in ")), func(hx_obj_20 map[string]any) *string {
		hx_field_21 := hx_obj_20["className"]
		if hx_field_21 == nil {
			var hx_zero_22 *string
			return hx_zero_22
		}
		return hx_field_21.(*string)
	}(self.posInfos)), hxrt.StringFromLiteral(".")), func(hx_obj_23 map[string]any) *string {
		hx_field_24 := hx_obj_23["methodName"]
		if hx_field_24 == nil {
			var hx_zero_25 *string
			return hx_zero_25
		}
		return hx_field_24.(*string)
	}(self.posInfos)), hxrt.StringFromLiteral(" at ")), func(hx_obj_26 map[string]any) *string {
		hx_field_27 := hx_obj_26["fileName"]
		if hx_field_27 == nil {
			var hx_zero_28 *string
			return hx_zero_28
		}
		return hx_field_27.(*string)
	}(self.posInfos)), hxrt.StringFromLiteral(":")), func(hx_obj_29 map[string]any) int {
		hx_field_30 := hx_obj_29["lineNumber"]
		if hx_field_30 == nil {
			var hx_zero_31 int
			return hx_zero_31
		}
