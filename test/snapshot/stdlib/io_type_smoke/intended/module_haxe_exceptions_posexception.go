...
func New_haxe__exceptions__PosException(message *string, previous *hxrt.ExceptionValue, pos map[string]any) *haxe__exceptions__PosException {
	...
	if pos == nil {
		...
		hx_obj_32["fileName"] = hxrt.StringFromLiteral("(unknown)")
		hx_obj_32["lineNumber"] = 0
		hx_obj_32["className"] = hxrt.StringFromLiteral("(unknown)")
		hx_obj_32["methodName"] = hxrt.StringFromLiteral("(unknown)")
		self.posInfos = hx_obj_32
	} else {
		self.posInfos = pos
	}
	return self
...
func (self *haxe__exceptions__PosException) toString() *string {
	return hxrt.StringConcatAny(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.ExceptionMessage(self), hxrt.StringFromLiteral(" in ")), func(hx_obj_33 map[string]any) *string {
		hx_field_34 := hx_obj_33["className"]
		if hx_field_34 == nil {
			var hx_zero_35 *string
			return hx_zero_35
		}
		return hx_field_34.(*string)
	}(self.posInfos)), hxrt.StringFromLiteral(".")), func(hx_obj_36 map[string]any) *string {
		hx_field_37 := hx_obj_36["methodName"]
		if hx_field_37 == nil {
			var hx_zero_38 *string
			return hx_zero_38
		}
		return hx_field_37.(*string)
	}(self.posInfos)), hxrt.StringFromLiteral(" at ")), func(hx_obj_39 map[string]any) *string {
		hx_field_40 := hx_obj_39["fileName"]
		if hx_field_40 == nil {
			var hx_zero_41 *string
			return hx_zero_41
		}
		return hx_field_40.(*string)
	}(self.posInfos)), hxrt.StringFromLiteral(":")), func(hx_obj_42 map[string]any) int {
		hx_field_43 := hx_obj_42["lineNumber"]
		if hx_field_43 == nil {
			var hx_zero_44 int
			return hx_zero_44
		}
