...
func (self *haxe__io__Input) readByte() int {
	return func() int {
		hxrt.Throw(New_haxe__exceptions__NotImplementedException(nil, nil, func() map[string]any {
			...
			hx_obj_4["fileName"] = hxrt.StringFromLiteral("haxe/io/Input.hx")
			hx_obj_4["lineNumber"] = 18
			hx_obj_4["className"] = hxrt.StringFromLiteral("haxe.io.Input")
			hx_obj_4["methodName"] = hxrt.StringFromLiteral("readByte")
			return hx_obj_4
		}()))
...
func (self *haxe__io__Input) readBytes(bytes *haxe__io__Bytes, pos int, len int) int {
	...
	hxrt.TryCatch(func() {
		...
		switch hx_typed_7 := hx_caught_6.(type) {
		case *haxe__io__Eof:
			hx_tmp := hx_typed_7
			_ = hx_tmp
		default:
			hxrt.Throw(hx_caught_6)
		}
	})
...
func (self *haxe__io__Input) readLine() *string {
	...
	hxrt.TryCatch(func() {
		...
		switch hx_typed_11 := hx_caught_10.(type) {
		case *haxe__io__Eof:
			error := hx_typed_11
			result = buffer.__hx_this.getBytes().__hx_this.toString()
...
func (self *haxe__io__Input) readDouble() float64 {
	...
	var hx_if_12 float64
	if self.bigEndian {
		hx_if_12 = haxe__io__FPHelper_i64ToDouble(second, first)
	} else {
		hx_if_12 = haxe__io__FPHelper_i64ToDouble(first, second)
	}
	return hx_if_12
}
...
func (self *haxe__io__Input) readInt8() int {
	...
	var hx_if_13 int
	if value >= 128 {
		hx_if_13 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(256))))
	} else {
		hx_if_13 = value
	}
	return hx_if_13
...
func (self *haxe__io__Input) readInt16() int {
	...
	var hx_if_14 int
	if self.bigEndian {
		hx_if_14 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_14 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	value := hx_if_14
	var hx_if_15 int
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(32768)))) != 0 {
		hx_if_15 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(65536))))
	} else {
		hx_if_15 = value
	}
	return hx_if_15
...
func (self *haxe__io__Input) readUInt16() int {
	...
	var hx_if_16 int
	if self.bigEndian {
		hx_if_16 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_16 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	return hx_if_16
}
...
func (self *haxe__io__Input) readInt24() int {
	...
	var hx_if_17 int
	if self.bigEndian {
		hx_if_17 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_17 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	value := hx_if_17
	var hx_if_18 int
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(8388608)))) != 0 {
		hx_if_18 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(16777216))))
	} else {
		hx_if_18 = value
	}
	return hx_if_18
...
func (self *haxe__io__Input) readUInt24() int {
	...
	var hx_if_19 int
	if self.bigEndian {
		hx_if_19 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_19 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	return hx_if_19
}
...
func (self *haxe__io__Input) readInt32() int {
	...
	var hx_if_20 int
	if self.bigEndian {
		hx_if_20 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(24))))))))
	} else {
		hx_if_20 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) << uint(24))))))))
	}
	return hx_if_20
}
