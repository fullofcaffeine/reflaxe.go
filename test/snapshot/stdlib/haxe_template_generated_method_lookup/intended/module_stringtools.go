...
func StringTools_hex(n int, digits any) *string {
	...
	hx_do_first_271 := true
	for hx_do_first_271 || (value > 0) {
		hx_do_first_271 = false
	...
	if digits == nil {
		...
		hx_if_272 = digits.(int)
	}
	resolvedDigits := hx_if_272
...
func StringTools_ltrim(s *string) *string {
	...
	var hx_if_275 *string
	if r > 0 {
		hx_if_275 = hxrt.StringSubstrStringPtr(s, r, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_275 = s
	}
	return hx_if_275
...
func StringTools_rtrim(s *string) *string {
	...
	var hx_if_277 *string
	if r > 0 {
		hx_if_277 = hxrt.StringSubstrStringPtr(s, 0, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_277 = s
	}
	return hx_if_277
