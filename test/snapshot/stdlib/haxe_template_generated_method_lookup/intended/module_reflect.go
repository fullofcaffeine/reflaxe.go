...
func Reflect_fields(o any) *hxrt.Array {
	...
	return hxrt.ArrayFromValues(func(hx_sort_src_264 []*string) []any {
		hx_sort_out_266 := make([]any, 0, len(hx_sort_src_264))
		for _, hx_sort_item_265 := range hx_sort_src_264 {
			hx_sort_out_266 = append(hx_sort_out_266, hx_sort_item_265)
		}
		return hx_sort_out_266
...
func Reflect_getProperty(o any, field *string) any {
	...
	if hxrt.AnyEqualsNull(getter) {
		hx_if_267 = Reflect_field(o, field)
	} else {
		hx_if_267 = Reflect_callMethod(o, getter, hxrt.NewArray())
	}
	return hx_if_267
}
