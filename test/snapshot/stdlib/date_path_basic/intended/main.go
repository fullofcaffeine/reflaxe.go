...
func Type_getClassFields(c any) *hxrt.Array {
	...
	case "haxe._Int64.___Int64":
		return hxrt.NewArray()
	case "haxe.io.Path":
		return hxrt.NewArray(hxrt.StringFromLiteral("addTrailingSlash"), hxrt.StringFromLiteral("join"), hxrt.StringFromLiteral("normalize"))
	default:
		return hxrt.NewArray()
	}
}
...
func Type_getInstanceFields(c any) *hxrt.Array {
	...
	case "haxe.io.Path":
		return hxrt.NewArray(hxrt.StringFromLiteral("backslash"), hxrt.StringFromLiteral("dir"), hxrt.StringFromLiteral("ext"), hxrt.StringFromLiteral("file"))
	default:
		return hxrt.NewArray()
	}
}
