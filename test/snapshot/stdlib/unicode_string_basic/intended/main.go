...
func main() {
	...
	hxrt.Println(hxrt.StringConcatAny(hxrt.StringFromLiteral("length="), _UnicodeString__UnicodeString_Impl__get_length(hxrt.StdString(s))))
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("char1="), _UnicodeString__UnicodeString_Impl__charAt(hxrt.StdString(s), 1)))
	hxrt.Println(hxrt.StringConcatAny(hxrt.StringFromLiteral("code1="), _UnicodeString__UnicodeString_Impl__charCodeAt(hxrt.StdString(s), 1)))
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("substr="), _UnicodeString__UnicodeString_Impl__substr(hxrt.StdString(s), 1, 2)))
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("substring="), _UnicodeString__UnicodeString_Impl__substring(hxrt.StdString(s), 1, 3)))
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("substring.swap="), _UnicodeString__UnicodeString_Impl__substring(hxrt.StdString(s), 3, 1)))
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("substring.neg="), _UnicodeString__UnicodeString_Impl__substring(hxrt.StdString(s), -2, 2)))
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("substring.omit="), _UnicodeString__UnicodeString_Impl__substring(hxrt.StdString(s), 2)))
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("substr.neglen="), _UnicodeString__UnicodeString_Impl__substr(hxrt.StdString(s), 1, -1)))
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("substr.negpos="), _UnicodeString__UnicodeString_Impl__substr(hxrt.StdString(s), -2, 2)))
	hxrt.Println(hxrt.StringConcatAny(hxrt.StringFromLiteral("index="), _UnicodeString__UnicodeString_Impl__indexOf(hxrt.StdString(s), hxrt.StringFromLiteral("bé"))))
	hxrt.Println(hxrt.StringConcatAny(hxrt.StringFromLiteral("index.empty="), _UnicodeString__UnicodeString_Impl__indexOf(hxrt.StdString(s), hxrt.StringFromLiteral(""))))
	hxrt.Println(hxrt.StringConcatAny(hxrt.StringFromLiteral("index.startNeg="), _UnicodeString__UnicodeString_Impl__indexOf(hxrt.StdString(s), hxrt.StringFromLiteral("bé"), -2)))
	hxrt.Println(hxrt.StringConcatAny(hxrt.StringFromLiteral("last="), _UnicodeString__UnicodeString_Impl__lastIndexOf(hxrt.StdString(s), hxrt.StringFromLiteral("a"))))
	hxrt.Println(hxrt.StringConcatAny(hxrt.StringFromLiteral("last.empty="), _UnicodeString__UnicodeString_Impl__lastIndexOf(hxrt.StdString(s), hxrt.StringFromLiteral(""))))
	hxrt.Println(hxrt.StringConcatAny(hxrt.StringFromLiteral("last.start="), _UnicodeString__UnicodeString_Impl__lastIndexOf(hxrt.StdString(s), hxrt.StringFromLiteral("bé"), 2)))
