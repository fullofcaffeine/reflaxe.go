...
func main() {
	...
	var v any = any(hxrt.StringConcatAny(hxrt.StringFromLiteral("length="), _UnicodeString__UnicodeString_Impl__get_length(hxrt.StdString(s))))
	hxrt.Println(v)
	...
	hxrt.Println(v_6)
	var v_7 any = any(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("substring.omit="), _UnicodeString__UnicodeString_Impl__substring(hxrt.StdString(s), 2)))
	hxrt.Println(v_7)
	...
	hxrt.Println(v_9)
	var v_10 any = any(hxrt.StringConcatAny(hxrt.StringFromLiteral("index="), _UnicodeString__UnicodeString_Impl__indexOf(hxrt.StdString(s), hxrt.StringFromLiteral("bé"))))
	hxrt.Println(v_10)
	var v_11 any = any(hxrt.StringConcatAny(hxrt.StringFromLiteral("index.empty="), _UnicodeString__UnicodeString_Impl__indexOf(hxrt.StdString(s), hxrt.StringFromLiteral(""))))
	hxrt.Println(v_11)
	...
	hxrt.Println(v_12)
	var v_13 any = any(hxrt.StringConcatAny(hxrt.StringFromLiteral("last="), _UnicodeString__UnicodeString_Impl__lastIndexOf(hxrt.StdString(s), hxrt.StringFromLiteral("a"))))
	hxrt.Println(v_13)
	var v_14 any = any(hxrt.StringConcatAny(hxrt.StringFromLiteral("last.empty="), _UnicodeString__UnicodeString_Impl__lastIndexOf(hxrt.StdString(s), hxrt.StringFromLiteral(""))))
	hxrt.Println(v_14)
	...
	hxrt.Println(v_15)
	var v_16 any = any(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("valid.utf8="), hxrt.StdString(_UnicodeString__UnicodeString_Impl__validate(haxe__io__Bytes_ofString(hxrt.StringFromLiteral("ok")), haxe__io__Encoding_UTF8))))
	hxrt.Println(v_16)
	var v_17 any = any(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("valid.invalid="), hxrt.StdString(_UnicodeString__UnicodeString_Impl__validate(haxe__io__Bytes_ofHex(hxrt.StringFromLiteral("ff")), haxe__io__Encoding_UTF8))))
	hxrt.Println(v_17)
	hxrt.TryCatch(func() {
		...
		error := hx_caught_1
		var v_18 any = any(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("valid.raw="), hxrt.StdString(error)))
		hxrt.Println(v_18)
	})
}
