...
func Reflect_fields(o any) *hxrt.Array {
	...
	return hxrt.ArrayFromValues(func(hx_sort_src_4 []*string) []any {
...
func Reflect_getProperty(o any, field *string) any {
	...
	if hxrt.AnyEqualsNull(getter) {
		hx_if_7 = Reflect_field(o, field)
	} else {
		hx_if_7 = Reflect_callMethod(o, getter, hxrt.NewArray())
	}
	return hx_if_7
}
