...
func StringTools_fastCodeAt(s *string, index int) int {
	...
	if c == nil {
		...
		hx_if_93 = hxrt.IntFromNullableAny(c)
	}
	return hx_if_93
}
...
func StringTools_hex(n int, digits any) *string {
	...
	hx_do_first_94 := true
	for hx_do_first_94 || (value > 0) {
		hx_do_first_94 = false
	...
	if digits == nil {
		...
		hx_if_95 = hxrt.IntFromNullableAny(digits.(int))
	}
	resolvedDigits := hx_if_95
...
func StringTools_hexDigitValue(value *string) int {
	...
	if c == nil {
		...
		hx_if_96 = hxrt.IntFromNullableAny(c)
	}
	code := hx_if_96
	if code == -1 {
		return -1
...
func StringTools_isSpace(s *string, pos int) bool {
	...
	if c_1 == nil {
		...
		hx_if_97 = hxrt.IntFromNullableAny(c_1)
	}
	c := hx_if_97
...
func StringTools_ltrim(s *string) *string {
	...
	var hx_if_98 *string
	if r > 0 {
		hx_if_98 = hxrt.StringSubstrStringPtr(s, r, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_98 = s
	}
	return hx_if_98
...
func StringTools_rtrim(s *string) *string {
	...
	if r > 0 {
		hx_if_100 = hxrt.StringSubstrStringPtr(s, 0, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_100 = s
	}
	return hx_if_100
...
func StringTools_unsafeCodeAt(s *string, index int) int {
	...
	if c == nil {
		...
		hx_if_101 = hxrt.IntFromNullableAny(c)
	}
	return hx_if_101
}
