...
func haxe__io___Float32Array__Float32Array_Impl__fromArray(a []float64, pos int, length any) *haxe__io__ArrayBufferViewImpl {
	...
	if hxrt.AnyEqualsNull(length) {
		hx_if_97 = int(int32((hxrt.Int32Wrap(len(a)) - hxrt.Int32Wrap(pos))))
	} else {
		hx_if_97 = hxrt.IntFromNullableAny(func(hx_value_95 any) int {
			if hx_value_95 == nil {
				var hx_zero_96 int
				return hx_zero_96
			}
			return hx_value_95.(int)
		}(length))
	}
	resolvedLength := hx_if_97
	if ((pos < 0) || (resolvedLength < 0)) || (int(int32((hxrt.Int32Wrap(pos) + hxrt.Int32Wrap(resolvedLength)))) > len(a)) {
		hxrt.Throw(haxe__io__Error_OutsideBounds)
		var hx_throw_zero_98 *haxe__io__ArrayBufferViewImpl
...
func haxe__io___Float32Array__Float32Array_Impl__fromBytes(bytes *haxe__io__Bytes, bytePos int, length any) *haxe__io__ArrayBufferViewImpl {
	...
	if hxrt.AnyEqualsNull(length) {
		...
		hx_if_102 = int(int32((hxrt.Int32Wrap(func(hx_value_100 any) int {
			if hx_value_100 == nil {
				var hx_zero_101 int
				return hx_zero_101
			}
	...
	var resolvedLength any = hx_if_102
...
func haxe__io___Float32Array__Float32Array_Impl__sub(this1 *haxe__io__ArrayBufferViewImpl, begin int, length any) *haxe__io__ArrayBufferViewImpl {
	...
	if hxrt.AnyEqualsNull(length) {
		...
		hx_if_105 = int(int32((hxrt.Int32Wrap(func(hx_value_103 any) int {
			if hx_value_103 == nil {
				var hx_zero_104 int
				return hx_zero_104
			}
			return hx_value_103.(int)
		}(length)) << uint(2))))
	}
	var scaledLength any = hx_if_105
...
func haxe__io___Float32Array__Float32Array_Impl__subarray(this1 *haxe__io__ArrayBufferViewImpl, begin any, end any) *haxe__io__ArrayBufferViewImpl {
	...
	if hxrt.AnyEqualsNull(begin) {
		...
		hx_if_108 = int(int32((hxrt.Int32Wrap(func(hx_value_106 any) int {
			if hx_value_106 == nil {
				var hx_zero_107 int
				return hx_zero_107
			}
			return hx_value_106.(int)
		}(begin)) << uint(2))))
	}
	var scaledBegin any = hx_if_108
	var hx_if_111 any
	if hxrt.AnyEqualsNull(end) {
		hx_if_111 = nil
	} else {
		hx_if_111 = int(int32((hxrt.Int32Wrap(func(hx_value_109 any) int {
			if hx_value_109 == nil {
				var hx_zero_110 int
				return hx_zero_110
			}
			return hx_value_109.(int)
		}(end)) << uint(2))))
	}
	var scaledEnd any = hx_if_111
