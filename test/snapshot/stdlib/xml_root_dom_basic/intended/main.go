...
func main() {
	...
	root.__hx_this.set(hxrt.StringFromLiteral("id"), hxrt.StringFromLiteral("r1"))
	root.__hx_this.addChild(Xml_createPCData(hxrt.StringFromLiteral("hello")))
	doc.__hx_this.addChild(root)
	...
	var v any = any(doc.__hx_this.toString())
	hxrt.Println(v)
	var v_1 any = any(parsed.__hx_this.firstElement().__hx_this.firstElement().__hx_this.get(hxrt.StringFromLiteral("a")))
	hxrt.Println(v_1)
	var v_2 any = any(parsed.__hx_this.toString())
	hxrt.Println(v_2)
	var v_3 any = any(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("type="), _Xml__XmlType_Impl__toString(hxrt.IntFromNullableAny(parsedCData.__hx_this.firstElement().__hx_this.firstChild().nodeType))))
	hxrt.Println(v_3)
	var v_4 any = any(parsedCData.__hx_this.toString())
	hxrt.Println(v_4)
}
