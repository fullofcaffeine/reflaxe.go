...
func haxe__xml__Parser_doParse(str *string, strict bool, p int, parent *Xml) int {
	...
	for p < hxrt.StringLengthStringPtr(str) {
		...
		case 8:
			...
			case 38:
				...
				if len == nil {
					...
					hx_if_80 = hxrt.StringSubstrStringPtr(str, start, len.(int), true)
				}
			...
			case 60, 62:
				if strict {
					...
					if c == attrValQuote {
						...
						var hx_if_82 *string
						if len_1 == nil {
							hx_if_82 = hxrt.StringSubstrStringPtr(str, start, 0, false)
						} else {
							hx_if_82 = hxrt.StringSubstrStringPtr(str, start, len_1.(int), true)
						}
						buf.b = hxrt.StringConcatStringPtr(buf.b, hx_if_82)
						val := buf.b
						buf = New_StringBuf()
						xml.set(aname, val)
						state = any(0)
			...
			default:
				if c == attrValQuote {
					...
					var hx_if_83 *string
					if len_2 == nil {
						hx_if_83 = hxrt.StringSubstrStringPtr(str, start, 0, false)
					} else {
						hx_if_83 = hxrt.StringSubstrStringPtr(str, start, len_2.(int), true)
					}
					buf.b = hxrt.StringConcatStringPtr(buf.b, hx_if_83)
					val_1 := buf.b
					buf = New_StringBuf()
					xml.set(aname, val_1)
					state = any(0)
		...
		case 10:
			if !((((((((c >= 97) && (c <= 122)) || ((c >= 65) && (c <= 90))) || ((c >= 48) && (c <= 57))) || (c == 58)) || (c == 46)) || (c == 95)) || (c == 45)) {
				...
				if !hxrt.StringEqualStringPtr(v, parent.get_nodeName()) {
					...
					var hx_throw_zero_86 int
					return hx_throw_zero_86
				}
				state = any(0)
				next = any(12)
				continue
		...
		case 11:
			if c == 62 {
				...
				hxrt.Throw(New_haxe__xml__XmlParserException(hxrt.StringFromLiteral("Expected >"), str, p))
				var hx_throw_zero_87 int
				return hx_throw_zero_87
			}
		case 12:
			if c == 62 {
				if nsubs == 0 {
		...
		case 13:
			if c == 60 {
				...
				var hx_if_89 *string
				if len_3 == nil {
					hx_if_89 = hxrt.StringSubstrStringPtr(str, start, 0, false)
				} else {
					hx_if_89 = hxrt.StringSubstrStringPtr(str, start, len_3.(int), true)
				}
				buf.b = hxrt.StringConcatStringPtr(buf.b, hx_if_89)
				...
				if c == 38 {
					...
					if len_4 == nil {
						...
						hx_if_90 = hxrt.StringSubstrStringPtr(str, start, len_4.(int), true)
					}
			...
			if c == 59 {
				...
				if func() int {
					...
					if func() int {
						...
						hx_if_97 = hxrt.StdParseInt(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("0"), hxrt.StringSubstrStringPtr(s, 1, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s))-hxrt.Int32Wrap(1)))), true)))
					} else {
						hx_if_97 = hxrt.StdParseInt(hxrt.StringSubstrStringPtr(s, 1, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(1)))), true))
					}
					var c_12 any = hx_if_97
					c_14 := hxrt.IntFromNullableAny(c_12)
					buf.b = hxrt.StringConcatStringPtr(buf.b, hxrt.StringFromCharCode(c_14))
				} else {
					if !func(hx_value_101 any) bool {
						if hx_value_101 == nil {
						...
						x := func(hx_value_99 any) *string {
							if hx_value_99 == nil {
								var hx_zero_100 *string
								return hx_zero_100
							}
							return hx_value_99.(*string)
				...
				if !((((((((c >= 97) && (c <= 122)) || ((c >= 65) && (c <= 90))) || ((c >= 48) && (c <= 57))) || (c == 58)) || (c == 46)) || (c == 95)) || (c == 45)) && (c != 35) {
					...
					if len_5 == nil {
						hx_if_105 = hxrt.StringSubstrStringPtr(str, start, 0, false)
					} else {
						hx_if_105 = hxrt.StringSubstrStringPtr(str, start, len_5.(int), true)
					}
					buf.b = hxrt.StringConcatStringPtr(buf.b, hx_if_105)
					p = int(int32((p - 1)))
					start = int(int32((hxrt.Int32Wrap(p) + hxrt.Int32Wrap(1))))
					state = escapeNext
				}
	...
	if state == any(13) {
		...
		if (p != start) || (nsubs == 0) {
			...
			if len_6 == nil {
				hx_if_107 = hxrt.StringSubstrStringPtr(str, start, 0, false)
			} else {
				hx_if_107 = hxrt.StringSubstrStringPtr(str, start, len_6.(int), true)
			}
			buf.b = hxrt.StringConcatStringPtr(buf.b, hx_if_107)
	...
	if (!strict && (state == any(18))) && (escapeNext == any(13)) {
		...
		if len_7 == nil {
			hx_if_108 = hxrt.StringSubstrStringPtr(str, start, 0, false)
		} else {
			hx_if_108 = hxrt.StringSubstrStringPtr(str, start, len_7.(int), true)
		}
		buf.b = hxrt.StringConcatStringPtr(buf.b, hx_if_108)
	...
	var hx_throw_zero_109 int
	return hx_throw_zero_109
}
