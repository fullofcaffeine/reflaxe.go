...
func StringTools_hex(n int, digits any) *string {
	...
	hx_do_first_154 := true
	for hx_do_first_154 || (value > 0) {
		hx_do_first_154 = false
	...
	if digits == nil {
		...
		hx_if_155 = digits.(int)
	}
	resolvedDigits := hx_if_155
...
func StringTools_ltrim(s *string) *string {
	...
	if r > 0 {
		hx_if_158 = hxrt.StringSubstrStringPtr(s, r, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_158 = s
	}
	return hx_if_158
...
func StringTools_rtrim(s *string) *string {
	...
	if r > 0 {
		hx_if_160 = hxrt.StringSubstrStringPtr(s, 0, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_160 = s
	}
	return hx_if_160
