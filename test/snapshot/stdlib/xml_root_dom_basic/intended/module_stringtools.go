...
func StringTools_hex(n int, digits any) *string {
	...
	hx_do_first_141 := true
	for hx_do_first_141 || (value > 0) {
		hx_do_first_141 = false
	...
	if digits == nil {
		...
		hx_if_142 = digits.(int)
	}
	resolvedDigits := hx_if_142
...
func StringTools_ltrim(s *string) *string {
	...
	if r > 0 {
		hx_if_145 = hxrt.StringSubstrStringPtr(s, r, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_145 = s
	}
	return hx_if_145
...
func StringTools_rtrim(s *string) *string {
	...
	if r > 0 {
		hx_if_147 = hxrt.StringSubstrStringPtr(s, 0, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_147 = s
	}
	return hx_if_147
