...
func Reflect_fields(o any) *hxrt.Array {
	...
	return hxrt.ArrayFromValues(func(hx_sort_src_231 []*string) []any {
		hx_sort_out_233 := make([]any, 0, len(hx_sort_src_231))
		for _, hx_sort_item_232 := range hx_sort_src_231 {
			hx_sort_out_233 = append(hx_sort_out_233, hx_sort_item_232)
		}
		return hx_sort_out_233
...
func Reflect_getProperty(o any, field *string) any {
	...
	if hxrt.AnyEqualsNull(getter) {
		hx_if_234 = Reflect_field(o, field)
	} else {
		hx_if_234 = Reflect_callMethod(o, getter, hxrt.NewArray())
	}
	return hx_if_234
}
