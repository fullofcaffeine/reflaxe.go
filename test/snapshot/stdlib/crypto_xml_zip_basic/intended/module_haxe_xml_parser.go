...
func haxe__xml__Parser_doParse(str *string, strict bool, p int, parent *Xml) int {
		...
		case 5:
			if !((((((((c >= 97) && (c <= 122)) || ((c >= 65) && (c <= 90))) || ((c >= 48) && (c <= 57))) || (c == 58)) || (c == 46)) || (c == 95)) || (c == 45)) {
				...
				if start == p {
					...
					var hx_throw_zero_54 int
					return hx_throw_zero_54
				}
				...
				if xml.exists(aname) {
					...
					var hx_throw_zero_55 int
					return hx_throw_zero_55
				}
				state = any(0)
				next = any(6)
				continue
				...
				if strict {
					...
					if c == attrValQuote {
						...
						if len_1 == nil {
							...
							hx_if_60 = hxrt.StringSubstrStringPtr(str, start, len_1.(int), true)
						}
			...
			default:
				if c == attrValQuote {
					...
					if len_2 == nil {
						...
						hx_if_61 = hxrt.StringSubstrStringPtr(str, start, len_2.(int), true)
					}
		...
		case 13:
			if c == 60 {
				...
				if len_3 == nil {
					...
					hx_if_67 = hxrt.StringSubstrStringPtr(str, start, len_3.(int), true)
				}
				...
				if c == 38 {
					...
					if len_4 == nil {
						...
						hx_if_68 = hxrt.StringSubstrStringPtr(str, start, len_4.(int), true)
					}
			...
			if c == 59 {
				...
				if func() int {
					...
					if func() int {
						...
						hx_if_75 = hxrt.StdParseInt(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("0"), hxrt.StringSubstrStringPtr(s, 1, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s))-hxrt.Int32Wrap(1)))), true)))
					} else {
						hx_if_75 = hxrt.StdParseInt(hxrt.StringSubstrStringPtr(s, 1, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(1)))), true))
					}
					var c_12 any = hx_if_75
					c_14 := hxrt.IntFromNullableAny(c_12)
					buf.b = hxrt.StringConcatStringPtr(buf.b, hxrt.StringFromCharCode(c_14))
				} else {
					if !func(hx_value_79 any) bool {
						if hx_value_79 == nil {
							var hx_zero_80 bool
							return hx_zero_80
						}
				...
				if !((((((((c >= 97) && (c <= 122)) || ((c >= 65) && (c <= 90))) || ((c >= 48) && (c <= 57))) || (c == 58)) || (c == 46)) || (c == 95)) || (c == 45)) && (c != 35) {
					...
					if len_5 == nil {
						...
						hx_if_83 = hxrt.StringSubstrStringPtr(str, start, len_5.(int), true)
					}
	...
	if state == any(13) {
		...
		if (p != start) || (nsubs == 0) {
			...
			var hx_if_85 *string
			if len_6 == nil {
				hx_if_85 = hxrt.StringSubstrStringPtr(str, start, 0, false)
			} else {
				hx_if_85 = hxrt.StringSubstrStringPtr(str, start, len_6.(int), true)
			}
			buf.b = hxrt.StringConcatStringPtr(buf.b, hx_if_85)
	...
	if (!strict && (state == any(18))) && (escapeNext == any(13)) {
		...
		var hx_if_86 *string
		if len_7 == nil {
			hx_if_86 = hxrt.StringSubstrStringPtr(str, start, 0, false)
		} else {
			hx_if_86 = hxrt.StringSubstrStringPtr(str, start, len_7.(int), true)
		}
		buf.b = hxrt.StringConcatStringPtr(buf.b, hx_if_86)
