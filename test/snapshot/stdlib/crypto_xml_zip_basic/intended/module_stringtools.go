...
func StringTools_hex(n int, digits any) *string {
	...
	hx_do_first_142 := true
	for hx_do_first_142 || (value > 0) {
		hx_do_first_142 = false
	...
	if digits == nil {
		...
		hx_if_143 = digits.(int)
	}
	resolvedDigits := hx_if_143
...
func StringTools_ltrim(s *string) *string {
	...
	if r > 0 {
		hx_if_146 = hxrt.StringSubstrStringPtr(s, r, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_146 = s
	}
	return hx_if_146
...
func StringTools_rtrim(s *string) *string {
	...
	var hx_if_148 *string
	if r > 0 {
		hx_if_148 = hxrt.StringSubstrStringPtr(s, 0, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_148 = s
	}
	return hx_if_148
