...
func StringTools_hex(n int, digits any) *string {
	...
	hx_do_first_163 := true
	for hx_do_first_163 || (value > 0) {
		hx_do_first_163 = false
	...
	if digits == nil {
		...
		hx_if_164 = digits.(int)
	}
	resolvedDigits := hx_if_164
...
func StringTools_ltrim(s *string) *string {
	...
	var hx_if_167 *string
	if r > 0 {
		hx_if_167 = hxrt.StringSubstrStringPtr(s, r, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_167 = s
	}
	return hx_if_167
...
func StringTools_rtrim(s *string) *string {
	...
	if r > 0 {
		hx_if_169 = hxrt.StringSubstrStringPtr(s, 0, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_169 = s
	}
	return hx_if_169
