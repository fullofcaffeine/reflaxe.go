...
func Reflect_fields(o any) *hxrt.Array {
	...
	return hxrt.ArrayFromValues(func(hx_sort_src_50 []*string) []any {
		hx_sort_out_52 := make([]any, 0, len(hx_sort_src_50))
		for _, hx_sort_item_51 := range hx_sort_src_50 {
			hx_sort_out_52 = append(hx_sort_out_52, hx_sort_item_51)
		}
		return hx_sort_out_52
...
func Reflect_getProperty(o any, field *string) any {
	...
	if hxrt.AnyEqualsNull(getter) {
		hx_if_53 = Reflect_field(o, field)
	} else {
		hx_if_53 = Reflect_callMethod(o, getter, hxrt.NewArray())
	}
	return hx_if_53
}
