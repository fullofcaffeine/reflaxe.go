...
func Type_getInstanceFields(c any) []*string {
	...
	case "sys.thread.ElasticThreadPool":
		return []*string{hxrt.StringFromLiteral("_isShutdown"), hxrt.StringFromLiteral("get_isShutdown"), hxrt.StringFromLiteral("get_threadsCount"), hxrt.StringFromLiteral("isShutdown"), hxrt.StringFromLiteral("maxThreadsCount"), hxrt.StringFromLiteral("mutex"), hxrt.StringFromLiteral("pool"), hxrt.StringFromLiteral("queue"), hxrt.StringFromLiteral("run"), hxrt.StringFromLiteral("shutdown"), hxrt.StringFromLiteral("threadTimeout"), hxrt.StringFromLiteral("threadsCount")}
	case "sys.thread.ElasticThreadPoolWorker":
		return []*string{hxrt.StringFromLiteral("dead"), hxrt.StringFromLiteral("deathMutex"), hxrt.StringFromLiteral("isShutdown"), hxrt.StringFromLiteral("loop"), hxrt.StringFromLiteral("queue"), hxrt.StringFromLiteral("shutdown"), hxrt.StringFromLiteral("start"), hxrt.StringFromLiteral("task"), hxrt.StringFromLiteral("timeout"), hxrt.StringFromLiteral("waiter"), hxrt.StringFromLiteral("wakeup")}
	case "sys.thread.EventLoop":
	...
	case "sys.thread.FixedThreadPool":
		return []*string{hxrt.StringFromLiteral("_isShutdown"), hxrt.StringFromLiteral("get_isShutdown"), hxrt.StringFromLiteral("get_threadsCount"), hxrt.StringFromLiteral("isShutdown"), hxrt.StringFromLiteral("pool"), hxrt.StringFromLiteral("queue"), hxrt.StringFromLiteral("run"), hxrt.StringFromLiteral("shutdown"), hxrt.StringFromLiteral("threadsCount")}
	case "sys.thread.FixedThreadPoolShutdownException":
