...
func main() {
	...
	hxrt.Println(hxrt.StringConcatAny(hxrt.StringFromLiteral("raw.len="), raw.length))
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("raw.hex="), raw.toHex()))
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("raw.get="), raw.getString(0, raw.length, haxe__io__Encoding_RawNative)))
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("raw.base64.before="), haxe__crypto__Base64_encode(raw)))
	raw.b[0] = 65
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("raw.hex.after="), raw.toHex()))
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("raw.get.after="), raw.getString(0, raw.length, haxe__io__Encoding_RawNative)))
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("raw.base64.after="), haxe__crypto__Base64_encode(raw)))
	output := New_haxe__io__BytesOutput()
	output.writeString(sample, haxe__io__Encoding_RawNative)
	written := output.getBytes()
	hxrt.Println(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("out.hex="), written.toHex()))
