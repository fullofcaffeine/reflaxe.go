...
func main() {
	...
	hxrt.Println(v)
	var v_1 any = any(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("raw.hex="), raw.toHex()))
	hxrt.Println(v_1)
	var v_2 any = any(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("raw.get="), raw.getString(0, raw.length, haxe__io__Encoding_RawNative)))
	hxrt.Println(v_2)
	var v_3 any = any(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("raw.base64.before="), haxe__crypto__Base64_encode(raw)))
	hxrt.Println(v_3)
	raw.b[0] = 65
	var v_4 any = any(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("raw.hex.after="), raw.toHex()))
	hxrt.Println(v_4)
	var v_5 any = any(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("raw.get.after="), raw.getString(0, raw.length, haxe__io__Encoding_RawNative)))
	hxrt.Println(v_5)
	var v_6 any = any(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("raw.base64.after="), haxe__crypto__Base64_encode(raw)))
	hxrt.Println(v_6)
	output := New_haxe__io__BytesOutput()
	output.writeString(sample, haxe__io__Encoding_RawNative)
	written := output.getBytes()
	var v_7 any = any(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("out.hex="), written.toHex()))
	hxrt.Println(v_7)
	input := New_haxe__io__BytesInput(written)
	var v_8 any = any(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("in.raw="), input.readString(written.length, haxe__io__Encoding_RawNative)))
	hxrt.Println(v_8)
}
