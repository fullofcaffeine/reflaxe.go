...
func main() {
	...
	_ = 5
	sum := int(int32((hxrt.Int32Wrap(hxrt.IntFromNullableAny(hxrt.IntFromNullableAny(func(hx_value_2 any) any {
		if hx_value_2 == nil {
			return nil
		}
		return hx_value_2.(int)
	}(Reflect_field(values, hxrt.StringFromLiteral("left")))))) + hxrt.Int32Wrap(hxrt.IntFromNullableAny(hxrt.IntFromNullableAny(func(hx_value_3 any) any {
		if hx_value_3 == nil {
			return nil
		}
