...
func (self *haxe__ds__IntMap) keyValueIterator() map[string]any {
	...
	hx_obj_20["next"] = func() map[string]any {
		...
		hx_obj_27["key"] = key
		hx_obj_27["value"] = _gthis.__hx_this.get(key)
		return hx_obj_27
	}
	return hx_obj_20
}
...
func (self *haxe__ds__IntMap) getIMap(key any) any {
	return self.__hx_this.get(hxrt.IntFromNullableAny(func(hx_value_28 any) int {
		if hx_value_28 == nil {
			var hx_zero_29 int
			return hx_zero_29
		}
...
func (self *haxe__ds__IntMap) setIMap(key any, value any) {
	self.__hx_this.set(hxrt.IntFromNullableAny(func(hx_value_30 any) int {
		if hx_value_30 == nil {
			var hx_zero_31 int
			return hx_zero_31
		}
...
func (self *haxe__ds__IntMap) existsIMap(key any) bool {
	...
	}(self.__hx_this.exists(hxrt.IntFromNullableAny(func(hx_value_32 any) int {
		if hx_value_32 == nil {
			var hx_zero_33 int
			return hx_zero_33
		}
...
func (self *haxe__ds__IntMap) removeIMap(key any) bool {
	...
	}(self.__hx_this.remove(hxrt.IntFromNullableAny(func(hx_value_36 any) int {
		if hx_value_36 == nil {
			var hx_zero_37 int
			return hx_zero_37
		}
