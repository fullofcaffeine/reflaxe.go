...
func (self *haxe__ds__BalancedTree) keyValueIterator() map[string]any {
	...
	hx_obj_36["next"] = func() map[string]any {
		...
		hx_obj_43["key"] = key
		hx_obj_43["value"] = _gthis.__hx_this.get(key)
		return hx_obj_43
	}
	return hx_obj_36
}
...
func (self *haxe__ds__BalancedTree) removeLoop(k any, node *haxe__ds__TreeNode) *haxe__ds__TreeNode {
	...
	if c == 0 {
		...
		if c < 0 {
			...
			}(self.__hx_this.balance(func(hx_value_61 any) *haxe__ds__TreeNode {
				if hx_value_61 == nil {
			...
			}(self.__hx_this.balance(node.left, node.key, node.value, func(hx_value_65 any) *haxe__ds__TreeNode {
				if hx_value_65 == nil {
...
func (self *haxe__ds__BalancedTree) merge(t1 *haxe__ds__TreeNode, t2 *haxe__ds__TreeNode) *haxe__ds__TreeNode {
	...
	}(self.__hx_this.balance(t1, t.key, t.value, func(hx_value_78 any) *haxe__ds__TreeNode {
		if hx_value_78 == nil {
...
func (self *haxe__ds__BalancedTree) removeMinBinding(t *haxe__ds__TreeNode) *haxe__ds__TreeNode {
	...
	if t.left == nil {
		...
		}(self.__hx_this.balance(func(hx_value_87 any) *haxe__ds__TreeNode {
			if hx_value_87 == nil {
