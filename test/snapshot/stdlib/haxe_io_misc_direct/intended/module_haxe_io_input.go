...
func (self *haxe__io__Input) readByte() int {
	return func() int {
		hxrt.Throw(New_haxe__exceptions__NotImplementedException(nil, nil, func() map[string]any {
			...
			hx_obj_45["fileName"] = hxrt.StringFromLiteral("haxe/io/Input.hx")
			hx_obj_45["lineNumber"] = 18
			hx_obj_45["className"] = hxrt.StringFromLiteral("haxe.io.Input")
			hx_obj_45["methodName"] = hxrt.StringFromLiteral("readByte")
			return hx_obj_45
		}()))
		var hx_throw_zero_46 int
...
func (self *haxe__io__Input) readLine() *string {
	...
	}, func(hx_caught_51 any) {
		switch hx_typed_52 := hx_caught_51.(type) {
		case *haxe__io__Eof:
			error := hx_typed_52
			result = buffer.__hx_this.getBytes().__hx_this.toString()
...
func (self *haxe__io__Input) readDouble() float64 {
	...
	var hx_if_53 float64
	if self.bigEndian {
		hx_if_53 = haxe__io__FPHelper_i64ToDouble(second, first)
	} else {
		hx_if_53 = haxe__io__FPHelper_i64ToDouble(first, second)
	}
	return hx_if_53
}
...
func (self *haxe__io__Input) readInt8() int {
	...
	var hx_if_54 int
	if value >= 128 {
		hx_if_54 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(256))))
	} else {
		hx_if_54 = value
	}
	return hx_if_54
...
func (self *haxe__io__Input) readInt16() int {
	...
	var hx_if_55 int
	if self.bigEndian {
		hx_if_55 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_55 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	value := hx_if_55
	var hx_if_56 int
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(32768)))) != 0 {
		hx_if_56 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(65536))))
	} else {
		hx_if_56 = value
	}
	return hx_if_56
...
func (self *haxe__io__Input) readUInt16() int {
	...
	var hx_if_57 int
	if self.bigEndian {
		hx_if_57 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_57 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	return hx_if_57
}
...
func (self *haxe__io__Input) readInt24() int {
	...
	var hx_if_58 int
	if self.bigEndian {
		hx_if_58 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_58 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	value := hx_if_58
	var hx_if_59 int
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(8388608)))) != 0 {
		hx_if_59 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(16777216))))
	} else {
		hx_if_59 = value
	}
	return hx_if_59
...
func (self *haxe__io__Input) readUInt24() int {
	...
	var hx_if_60 int
	if self.bigEndian {
		hx_if_60 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_60 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	return hx_if_60
}
...
func (self *haxe__io__Input) readInt32() int {
	...
	var hx_if_61 int
	if self.bigEndian {
		hx_if_61 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(24))))))))
	} else {
		hx_if_61 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) << uint(24))))))))
	}
	return hx_if_61
}
