...
func main() {
	...
	var v any = any(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatAny(hxrt.StringFromLiteral("stringInput="), stringInput.readByte()), hxrt.StringFromLiteral(",")), readTwo(stringInput)))
	hxrt.Println(v)
	buffered := New_haxe__io__BufferInput(New_haxe__io__StringInput(hxrt.StringFromLiteral("wxyz")), haxe__io__Bytes_alloc(2))
	var v_1 any = any(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatAny(hxrt.StringFromLiteral("bufferInput="), buffered.readByte()), hxrt.StringFromLiteral(",")), readTwo(buffered)))
	hxrt.Println(v_1)
	source := haxe__io__Bytes_ofString(hxrt.StringFromLiteral("ab"))
	data := source.b
	data[1] = 90
	var v_2 any = any(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("bytesData="), haxe__io__Bytes_ofData(data).toString()))
	hxrt.Println(v_2)
...
func Type_getClassFields(c any) *hxrt.Array {
	...
	switch className {
	case "Main":
		return hxrt.NewArray(hxrt.StringFromLiteral("errorTag"), hxrt.StringFromLiteral("main"), hxrt.StringFromLiteral("readTwo"))
	case "haxe.Int64Helper":
		return hxrt.NewArray()
	case "haxe._Int32.Int32_Impl_":
		return hxrt.NewArray(hxrt.StringFromLiteral("ucompare"))
	case "haxe._Int64.Int64_Impl_":
		return hxrt.NewArray(hxrt.StringFromLiteral("divMod"), hxrt.StringFromLiteral("toString"))
	case "haxe._Int64.___Int64":
		return hxrt.NewArray()
	case "haxe.io.FPHelper":
