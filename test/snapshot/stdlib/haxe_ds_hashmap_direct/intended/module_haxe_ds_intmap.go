...
func (self *haxe__ds__IntMap) keyValueIterator() map[string]any {
	...
	hx_obj_77["next"] = func() map[string]any {
		...
		hx_obj_84["key"] = key
		hx_obj_84["value"] = _gthis.__hx_this.get(key)
		return hx_obj_84
	}
	return hx_obj_77
}
...
func (self *haxe__ds__IntMap) getIMap(key any) any {
	return self.__hx_this.get(hxrt.IntFromNullableAny(func(hx_value_85 any) int {
		if hx_value_85 == nil {
			var hx_zero_86 int
			return hx_zero_86
		}
...
func (self *haxe__ds__IntMap) setIMap(key any, value any) {
	self.__hx_this.set(hxrt.IntFromNullableAny(func(hx_value_87 any) int {
		if hx_value_87 == nil {
			var hx_zero_88 int
			return hx_zero_88
		}
...
func (self *haxe__ds__IntMap) existsIMap(key any) bool {
	...
	}(self.__hx_this.exists(hxrt.IntFromNullableAny(func(hx_value_89 any) int {
		if hx_value_89 == nil {
			var hx_zero_90 int
			return hx_zero_90
		}
...
func (self *haxe__ds__IntMap) removeIMap(key any) bool {
	...
	}(self.__hx_this.remove(hxrt.IntFromNullableAny(func(hx_value_93 any) int {
		if hx_value_93 == nil {
			var hx_zero_94 int
			return hx_zero_94
		}
