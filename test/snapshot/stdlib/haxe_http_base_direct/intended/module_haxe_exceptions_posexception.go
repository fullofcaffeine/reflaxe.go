...
func New_haxe__exceptions__PosException(message *string, previous *hxrt.ExceptionValue, pos map[string]any) *haxe__exceptions__PosException {
	...
	if pos == nil {
		...
		hx_obj_18["fileName"] = hxrt.StringFromLiteral("(unknown)")
		hx_obj_18["lineNumber"] = 0
		hx_obj_18["className"] = hxrt.StringFromLiteral("(unknown)")
		hx_obj_18["methodName"] = hxrt.StringFromLiteral("(unknown)")
		self.posInfos = hx_obj_18
	} else {
		self.posInfos = pos
	}
	return self
...
func (self *haxe__exceptions__PosException) toString() *string {
	return hxrt.StringConcatAny(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.StringConcatStringPtr(hxrt.ExceptionMessage(self), hxrt.StringFromLiteral(" in ")), func(hx_obj_19 map[string]any) *string {
		hx_field_20 := hx_obj_19["className"]
		if hx_field_20 == nil {
			var hx_zero_21 *string
			return hx_zero_21
		}
		return hx_field_20.(*string)
	}(self.posInfos)), hxrt.StringFromLiteral(".")), func(hx_obj_22 map[string]any) *string {
		hx_field_23 := hx_obj_22["methodName"]
		if hx_field_23 == nil {
			var hx_zero_24 *string
			return hx_zero_24
		}
		return hx_field_23.(*string)
	}(self.posInfos)), hxrt.StringFromLiteral(" at ")), func(hx_obj_25 map[string]any) *string {
		hx_field_26 := hx_obj_25["fileName"]
		if hx_field_26 == nil {
			var hx_zero_27 *string
			return hx_zero_27
		}
		return hx_field_26.(*string)
	}(self.posInfos)), hxrt.StringFromLiteral(":")), func(hx_obj_28 map[string]any) int {
		hx_field_29 := hx_obj_28["lineNumber"]
		if hx_field_29 == nil {
			var hx_zero_30 int
			return hx_zero_30
		}
