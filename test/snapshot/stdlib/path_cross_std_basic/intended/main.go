...
func main() {
	...
	hxrt.Println(v_12)
	var v_13 any = any(haxe__io__Path_join([]*string{hxrt.StringFromLiteral("/tmp"), hxrt.StringFromLiteral("demo"), hxrt.StringFromLiteral(".."), hxrt.StringFromLiteral("out"), hxrt.StringFromLiteral("file.txt")}))
	hxrt.Println(v_13)
