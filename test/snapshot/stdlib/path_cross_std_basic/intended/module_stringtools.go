...
func StringTools_hex(n int, digits any) *string {
	...
	hx_do_first_24 := true
	for hx_do_first_24 || (value > 0) {
		hx_do_first_24 = false
...
func StringTools_ltrim(s *string) *string {
	...
	var hx_if_28 *string
	if r > 0 {
		hx_if_28 = hxrt.StringSubstrStringPtr(s, r, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_28 = s
	}
	return hx_if_28
...
func StringTools_rtrim(s *string) *string {
	...
	var hx_if_30 *string
	if r > 0 {
		hx_if_30 = hxrt.StringSubstrStringPtr(s, 0, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_30 = s
	}
	return hx_if_30
