...
func haxe__io__GoIoHelpers_outputWriteString(self haxe__io__Output, s *string, encoding *haxe__io__Encoding) {
	...
	var hx_if_16 *haxe__io__Bytes
	if encoding == nil {
		hx_if_16 = haxe__io__Bytes_ofString(s)
	} else {
		hx_if_16 = haxe__io__Bytes_ofString(s, encoding)
	}
	bytes := hx_if_16
