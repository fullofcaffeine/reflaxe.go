...
func (self *haxe__ds__StringMap) keys() map[string]any {
	...
	hx_obj_5["hasNext"] = func() bool {
		return (index < len(keys))
	}
	hx_obj_5["next"] = func() *string {
		hx_post_6 := index
		index = int(int32((index + 1)))
		return keys[hx_post_6]
	}
	return hx_obj_5
}
...
func (self *haxe__ds__StringMap) keyValueIterator() map[string]any {
	_gthis := self
	keys := func(hx_value_9 any) map[string]any {
		if hx_value_9 == nil {
	...
	hx_obj_11["next"] = func() map[string]any {
		key := func(hx_obj_15 map[string]any) func() *string {
		...
		hx_obj_18["key"] = key
		hx_obj_18["value"] = _gthis.__hx_this.get(key)
		return hx_obj_18
	}
	return hx_obj_11
}
...
func (self *haxe__ds__StringMap) getIMap(key any) any {
	return self.__hx_this.get(hxrt.StdString(func(hx_value_19 any) *string {
		if hx_value_19 == nil {
...
func (self *haxe__ds__StringMap) setIMap(key any, value any) {
	self.__hx_this.set(hxrt.StdString(func(hx_value_21 any) *string {
		if hx_value_21 == nil {
...
func (self *haxe__ds__StringMap) existsIMap(key any) bool {
	...
	}(self.__hx_this.exists(hxrt.StdString(func(hx_value_23 any) *string {
		if hx_value_23 == nil {
...
func (self *haxe__ds__StringMap) removeIMap(key any) bool {
	return func(hx_value_29 any) bool {
		if hx_value_29 == nil {
			var hx_zero_30 bool
			return hx_zero_30
		}
		return hx_value_29.(bool)
	}(self.__hx_this.remove(hxrt.StdString(func(hx_value_27 any) *string {
		if hx_value_27 == nil {
...
func (self *haxe__ds__StringMap) copyIMap() haxe__IMap {
	return func(hx_value_31 any) *haxe__ds__StringMap {
		if hx_value_31 == nil {
			var hx_zero_32 *haxe__ds__StringMap
			return hx_zero_32
		}
		return hx_value_31.(*haxe__ds__StringMap)
	}(self.__hx_this.copy())
}

func (self *haxe__ds__StringMap) copy() *haxe__ds__StringMap {
	copied := New_haxe__ds__StringMap()
	key := func(hx_value_33 any) map[string]any {
		if hx_value_33 == nil {
	...
	for func(hx_obj_35 map[string]any) func() bool {
		...
		key_1 := func(hx_obj_38 map[string]any) func() *string {
...
func (self *haxe__ds__StringMap) toString() *string {
	...
	iterator := func(hx_value_41 any) map[string]any {
		if hx_value_41 == nil {
	...
	for func(hx_obj_43 map[string]any) func() bool {
		...
		if func(hx_obj_49 map[string]any) func() bool {
