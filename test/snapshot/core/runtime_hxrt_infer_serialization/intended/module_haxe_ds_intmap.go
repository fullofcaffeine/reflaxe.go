...
func (self *haxe__ds__IntMap) keyValueIterator() map[string]any {
	...
	hx_obj_118["next"] = func() map[string]any {
		...
		hx_obj_125["key"] = key
		hx_obj_125["value"] = _gthis.get(key)
		return hx_obj_125
	}
	return hx_obj_118
}
...
func (self *haxe__ds__IntMap) getIMap(key any) any {
	return self.get(hxrt.IntFromNullableAny(func(hx_value_126 any) int {
		if hx_value_126 == nil {
			var hx_zero_127 int
			return hx_zero_127
		}
...
func (self *haxe__ds__IntMap) setIMap(key any, value any) {
	self.set(hxrt.IntFromNullableAny(func(hx_value_128 any) int {
		if hx_value_128 == nil {
			var hx_zero_129 int
			return hx_zero_129
		}
...
func (self *haxe__ds__IntMap) existsIMap(key any) bool {
	...
	}(self.exists(hxrt.IntFromNullableAny(func(hx_value_130 any) int {
		if hx_value_130 == nil {
			var hx_zero_131 int
			return hx_zero_131
		}
...
func (self *haxe__ds__IntMap) removeIMap(key any) bool {
	...
	}(self.remove(hxrt.IntFromNullableAny(func(hx_value_134 any) int {
		if hx_value_134 == nil {
			var hx_zero_135 int
			return hx_zero_135
		}
