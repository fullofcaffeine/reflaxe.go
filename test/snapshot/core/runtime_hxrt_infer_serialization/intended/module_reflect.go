...
func Reflect_fields(o any) *hxrt.Array {
	...
	return hxrt.ArrayFromValues(func(hx_sort_src_339 []*string) []any {
		hx_sort_out_341 := make([]any, 0, len(hx_sort_src_339))
		for _, hx_sort_item_340 := range hx_sort_src_339 {
			hx_sort_out_341 = append(hx_sort_out_341, hx_sort_item_340)
		}
		return hx_sort_out_341
...
func Reflect_getProperty(o any, field *string) any {
	...
	if hxrt.AnyEqualsNull(getter) {
		hx_if_342 = Reflect_field(o, field)
	} else {
		hx_if_342 = Reflect_callMethod(o, getter, hxrt.NewArray())
	}
	return hx_if_342
}
