...
func (self *haxe__io__Input) readByte() int {
	return func() int {
		hxrt.Throw(New_haxe__exceptions__NotImplementedException(nil, nil, func() map[string]any {
			...
			hx_obj_5["fileName"] = hxrt.StringFromLiteral("haxe/io/Input.hx")
			hx_obj_5["lineNumber"] = 18
			hx_obj_5["className"] = hxrt.StringFromLiteral("haxe.io.Input")
			hx_obj_5["methodName"] = hxrt.StringFromLiteral("readByte")
			return hx_obj_5
		}()))
		var hx_throw_zero_6 int
...
func (self *haxe__io__Input) readAll(bufsize any) *haxe__io__Bytes {
	...
	hxrt.TryCatch(func() {
		...
		switch hx_typed_10 := hx_caught_9.(type) {
		case *haxe__io__Eof:
			hx_tmp := hx_typed_10
			_ = hx_tmp
		default:
			hxrt.Throw(hx_caught_9)
		}
	})
...
func (self *haxe__io__Input) readDouble() float64 {
	...
	var hx_if_13 float64
	if self.bigEndian {
		hx_if_13 = haxe__io__FPHelper_i64ToDouble(second, first)
	} else {
		hx_if_13 = haxe__io__FPHelper_i64ToDouble(first, second)
	}
	return hx_if_13
}
...
func (self *haxe__io__Input) readInt8() int {
	...
	var hx_if_14 int
	if value >= 128 {
		hx_if_14 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(256))))
	} else {
		hx_if_14 = value
	}
	return hx_if_14
...
func (self *haxe__io__Input) readInt16() int {
	...
	var hx_if_15 int
	if self.bigEndian {
		hx_if_15 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_15 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	value := hx_if_15
	var hx_if_16 int
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(32768)))) != 0 {
		hx_if_16 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(65536))))
	} else {
		hx_if_16 = value
	}
	return hx_if_16
...
func (self *haxe__io__Input) readUInt16() int {
	...
	var hx_if_17 int
	if self.bigEndian {
		hx_if_17 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_17 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	return hx_if_17
}
...
func (self *haxe__io__Input) readInt24() int {
	...
	var hx_if_18 int
	if self.bigEndian {
		hx_if_18 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_18 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	value := hx_if_18
	var hx_if_19 int
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(8388608)))) != 0 {
		hx_if_19 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(16777216))))
	} else {
		hx_if_19 = value
	}
	return hx_if_19
...
func (self *haxe__io__Input) readUInt24() int {
	...
	var hx_if_20 int
	if self.bigEndian {
		hx_if_20 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_20 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	return hx_if_20
}
...
func (self *haxe__io__Input) readInt32() int {
	...
	var hx_if_21 int
	if self.bigEndian {
		hx_if_21 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(24))))))))
	} else {
		hx_if_21 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) << uint(24))))))))
	}
	return hx_if_21
}
