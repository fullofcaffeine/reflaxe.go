...
func main() {
	...
	hxrt.Println(v_1)
	var v_2 any = any(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("raw.get="), rawNative.getString(0, rawNative.length, haxe__io__Encoding_RawNative)))
	hxrt.Println(v_2)
	...
	var v_4 any = any(hxrt.StringConcatStringPtr(hxrt.StringFromLiteral("in.raw="), input.readString(written.length, haxe__io__Encoding_RawNative)))
	hxrt.Println(v_4)
}
