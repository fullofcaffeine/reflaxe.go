...
func main() {
	...
	values.set(CollectionFeatureKey_Entry(1), hxrt.StringFromLiteral("one"))
	...
	}(values.exists(CollectionFeatureKey_Entry(1)))
}
...
func Type_getClassFields(c any) []*string {
	...
	case "haxe.ds.EnumValueMap":
		return []*string{hxrt.StringFromLiteral("isEnumValue"), hxrt.StringFromLiteral("keysLoop"), hxrt.StringFromLiteral("valuesLoop")}
	case "haxe.ds._EnumValueMap.EnumValueTreeNode":
		return []*string{}
	default:
		return []*string{}
...
func Type_getEnumConstructs(e any) []*string {
	...
	switch enumName {
	case "CollectionFeatureKey":
		return []*string{hxrt.StringFromLiteral("Entry")}
	case "ValueType":
