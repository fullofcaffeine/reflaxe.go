...
func main() {
	...
	var v any = any(int((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) + hxrt.Int32Wrap(hxrt.StringLengthStringPtr(out)))))
	hxrt.Println(v)
	ch := go__concurrency_newChan__int_95e97e5e(0)
	go__concurrency_send__int_95e97e5e(ch.__hx_native, 7)
