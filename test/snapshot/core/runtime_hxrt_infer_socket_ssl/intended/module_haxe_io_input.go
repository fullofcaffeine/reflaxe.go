...
func (self *haxe__io__Input) readByte() int {
	return func() int {
		hxrt.Throw(New_haxe__exceptions__NotImplementedException(nil, nil, func() map[string]any {
			...
			hx_obj_68["fileName"] = hxrt.StringFromLiteral("haxe/io/Input.hx")
			hx_obj_68["lineNumber"] = 18
			hx_obj_68["className"] = hxrt.StringFromLiteral("haxe.io.Input")
			hx_obj_68["methodName"] = hxrt.StringFromLiteral("readByte")
			return hx_obj_68
		}()))
...
func (self *haxe__io__Input) readLine() *string {
	...
	}, func(hx_caught_74 any) {
		switch hx_typed_75 := hx_caught_74.(type) {
		case *haxe__io__Eof:
			error := hx_typed_75
			result = buffer.__hx_this.getBytes().__hx_this.toString()
...
func (self *haxe__io__Input) readDouble() float64 {
	...
	if self.bigEndian {
		hx_if_76 = haxe__io__FPHelper_i64ToDouble(second, first)
	} else {
		hx_if_76 = haxe__io__FPHelper_i64ToDouble(first, second)
	}
	return hx_if_76
}
...
func (self *haxe__io__Input) readInt8() int {
	...
	var hx_if_77 int
	if value >= 128 {
		hx_if_77 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(256))))
	} else {
		hx_if_77 = value
	}
	return hx_if_77
...
func (self *haxe__io__Input) readInt16() int {
	...
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(32768)))) != 0 {
		hx_if_79 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(65536))))
	} else {
		hx_if_79 = value
	}
	return hx_if_79
...
func (self *haxe__io__Input) readUInt16() int {
	...
	var hx_if_80 int
	if self.bigEndian {
		hx_if_80 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_80 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	return hx_if_80
}
...
func (self *haxe__io__Input) readInt24() int {
	...
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(8388608)))) != 0 {
		hx_if_82 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(16777216))))
	} else {
		hx_if_82 = value
	}
	return hx_if_82
...
func (self *haxe__io__Input) readUInt24() int {
	...
	var hx_if_83 int
	if self.bigEndian {
		hx_if_83 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_83 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	return hx_if_83
}
...
func (self *haxe__io__Input) readInt32() int {
	...
	var hx_if_84 int
	if self.bigEndian {
		hx_if_84 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(24))))))))
	} else {
		hx_if_84 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) << uint(24))))))))
	}
	return hx_if_84
}
