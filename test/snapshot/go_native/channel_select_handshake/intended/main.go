...
func main() {
	...
	var v any = any(go__concurrency_recv__int_95e97e5e(responses.__hx_native))
	hxrt.Println(v)
	buffered := go__concurrency_newChan__int_95e97e5e(1)
	var v_1 any = any(go__concurrency_trySend__int_95e97e5e(buffered.__hx_native, 7))
	hxrt.Println(v_1)
	var v_2 any = any(go__concurrency_trySend__int_95e97e5e(buffered.__hx_native, 8))
	hxrt.Println(v_2)
	var v_3 any = any(go__concurrency_recvOr__int_95e97e5e(buffered.__hx_native, -1))
	hxrt.Println(v_3)
	var v_4 any = any(go__concurrency_recvOr__int_95e97e5e(buffered.__hx_native, -1))
	hxrt.Println(v_4)
