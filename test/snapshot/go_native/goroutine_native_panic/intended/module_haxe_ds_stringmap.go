...
func (self *haxe__ds__StringMap) keyValueIterator() map[string]any {
	...
	hx_obj_25["next"] = func() map[string]any {
		...
		hx_obj_32["key"] = key
		hx_obj_32["value"] = _gthis.get(key)
		return hx_obj_32
	}
	return hx_obj_25
}
...
func (self *haxe__ds__StringMap) getIMap(key any) any {
	return self.get(hxrt.StdString(func(hx_value_33 any) *string {
		if hx_value_33 == nil {
...
func (self *haxe__ds__StringMap) setIMap(key any, value any) {
	self.set(hxrt.StdString(func(hx_value_35 any) *string {
		if hx_value_35 == nil {
...
func (self *haxe__ds__StringMap) existsIMap(key any) bool {
	...
	}(self.exists(hxrt.StdString(func(hx_value_37 any) *string {
		if hx_value_37 == nil {
...
func (self *haxe__ds__StringMap) removeIMap(key any) bool {
	...
	}(self.remove(hxrt.StdString(func(hx_value_41 any) *string {
		if hx_value_41 == nil {
