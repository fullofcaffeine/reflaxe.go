...
func go___Select_recv2_String_String(first *go___Chan, second *go___Chan) *go___SelectRecv2 {
	...
	if func(hx_value_14 any) bool {
		...
		return go___SelectRecv2_First(func(hx_value_16 any) *string {
			if hx_value_16 == nil {
	...
	if func(hx_value_18 any) bool {
		...
		return go___SelectRecv2_Second(func(hx_value_20 any) *string {
			if hx_value_20 == nil {
...
func go___Select_recv_Int(channel *go___Chan) *go___SelectRecv {
	...
	if func(hx_value_22 any) bool {
		...
		return go___SelectRecv_Received(func(hx_value_24 any) int {
			if hx_value_24 == nil {
				var hx_zero_25 int
				return hx_zero_25
			}
