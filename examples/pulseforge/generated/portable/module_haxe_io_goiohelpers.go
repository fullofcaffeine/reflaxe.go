...
func haxe__io__GoIoHelpers_inputReadAll(self haxe__io__Input, bufsize int) *haxe__io__Bytes {
	...
	for true {
		...
		}, func(hx_caught_54 any) {
			switch hx_typed_55 := hx_caught_54.(type) {
			case *haxe__io__Eof:
				hx_tmp := hx_typed_55
				_ = hx_tmp
				done = true
			default:
				hxrt.Throw(hx_caught_54)
			}
		})
		if done {
			break
...
func haxe__io__GoIoHelpers_inputReadLine(self haxe__io__Input) *string {
	...
	for true {
		...
		hxrt.TryCatch(func() {
			...
			switch hx_typed_59 := hx_caught_58.(type) {
			case *haxe__io__Eof:
				e := hx_typed_59
				...
				hx_try_value_57 = partial
				hx_try_return_56 = true
				return
			default:
				hxrt.Throw(hx_caught_58)
			}
		})
		if hx_try_return_56 {
...
func haxe__io__GoIoHelpers_outputWriteInput(self haxe__io__Output, i haxe__io__Input, bufsize int) {
	...
	for true {
		...
		}, func(hx_caught_60 any) {
			switch hx_typed_61 := hx_caught_60.(type) {
			case *haxe__io__Eof:
				hx_tmp := hx_typed_61
				_ = hx_tmp
				done = true
			default:
				hxrt.Throw(hx_caught_60)
			}
		})
		if done {
			break
...
func haxe__io__GoIoHelpers_outputWriteString(self haxe__io__Output, s *string, encoding *haxe__io__Encoding) {
	...
	var hx_if_62 *haxe__io__Bytes
	if encoding == nil {
		hx_if_62 = haxe__io__Bytes_ofString(s)
	} else {
		hx_if_62 = haxe__io__Bytes_ofString(s, encoding)
	}
	bytes := hx_if_62
