...
func Type_getInstanceFields(c any) []*string {
	...
	case "app.core.PulsePipeline":
		return []*string{hxrt.StringFromLiteral("aggregate"), hxrt.StringFromLiteral("alertToken"), hxrt.StringFromLiteral("collectAlerts"), hxrt.StringFromLiteral("ingest"), hxrt.StringFromLiteral("run"), hxrt.StringFromLiteral("runtime")}
	case "app.core.PulseReport":
