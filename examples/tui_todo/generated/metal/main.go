...
func hxrt_typeCreateClassInstance(className string, args []any) (any, bool) {
	...
	case "profile.MetalRuntime":
		return hxrt_typeCallAny(New_profile__MetalRuntime, args)
...
func hxrt_typeCreateClassEmptyInstance(className string) (any, bool) {
	...
	case "profile.MetalRuntime":
		return &profile__MetalRuntime{}, true
	case "profile.TodoRuntimeMetrics":
...
func Type_getClass(o any) any {
	...
	case *profile__MetalRuntime:
		if value == nil {
			return nil
		}
		return &hxrt__TypeClassValue{name: hxrt.StringFromLiteral("profile.MetalRuntime")}
