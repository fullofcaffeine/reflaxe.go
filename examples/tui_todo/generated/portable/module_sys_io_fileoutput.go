...
func (self *sys__io__FileOutput) writeBytes(bytes *haxe__io__Bytes, pos int, length int) int {
	...
	return hxrt.FileOutputWriteValues(self.handle, func(hx_lambda_raw_80 []any) []int {
		hx_lambda_out_81 := make([]int, 0, len(hx_lambda_raw_80))
		for _, hx_lambda_item_82 := range hx_lambda_raw_80 {
			hx_lambda_out_81 = append(hx_lambda_out_81, func(hx_value_83 any) int {
				if hx_value_83 == nil {
					var hx_zero_84 int
					return hx_zero_84
				}
