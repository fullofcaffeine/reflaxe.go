...
func haxe__io__GoIoHelpers_inputReadAll(self haxe__io__Input, bufsize int) *haxe__io__Bytes {
	...
	for true {
		...
		}, func(hx_caught_112 any) {
			switch hx_typed_113 := hx_caught_112.(type) {
			case *haxe__io__Eof:
				hx_tmp := hx_typed_113
				_ = hx_tmp
				done = true
			default:
				hxrt.Throw(hx_caught_112)
			}
		})
		if done {
			break
...
func haxe__io__GoIoHelpers_inputReadLine(self haxe__io__Input) *string {
	...
	for true {
		...
		_ = last
		ended := false
		hx_try_return_114 := false
		var hx_try_value_115 *string
		hxrt.TryCatch(func() {
			last = self.readByte()
			if last == 10 {
				ended = true
		...
		}, func(hx_caught_116 any) {
			switch hx_typed_117 := hx_caught_116.(type) {
			case *haxe__io__Eof:
				e := hx_typed_117
				...
				hx_try_value_115 = partial
				hx_try_return_114 = true
				return
			default:
				hxrt.Throw(hx_caught_116)
			}
		})
		if hx_try_return_114 {
			return hx_try_value_115
		}
		if ended {
			break
		}
...
func haxe__io__GoIoHelpers_outputWriteString(self haxe__io__Output, s *string, encoding *haxe__io__Encoding) {
	...
	var hx_if_120 *haxe__io__Bytes
	if encoding == nil {
		hx_if_120 = haxe__io__Bytes_ofString(s)
	} else {
		hx_if_120 = haxe__io__Bytes_ofString(s, encoding)
	}
	bytes := hx_if_120
