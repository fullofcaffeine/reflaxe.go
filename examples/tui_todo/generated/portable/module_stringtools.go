...
func StringTools_hex(n int, digits any) *string {
	...
	hx_do_first_127 := true
	for hx_do_first_127 || (value > 0) {
		hx_do_first_127 = false
	...
	if digits == nil {
		...
		hx_if_128 = digits.(int)
	}
	resolvedDigits := hx_if_128
...
func StringTools_ltrim(s *string) *string {
	...
	var hx_if_131 *string
	if r > 0 {
		hx_if_131 = hxrt.StringSubstrStringPtr(s, r, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_131 = s
	}
	return hx_if_131
...
func StringTools_rtrim(s *string) *string {
	...
	if r > 0 {
		hx_if_133 = hxrt.StringSubstrStringPtr(s, 0, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_133 = s
	}
	return hx_if_133
