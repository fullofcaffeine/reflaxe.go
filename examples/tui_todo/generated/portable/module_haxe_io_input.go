...
func (self *haxe__io__Input) readByte() int {
	return func() int {
		hxrt.Throw(New_haxe__exceptions__NotImplementedException(nil, nil, func() map[string]any {
			...
			hx_obj_99["fileName"] = hxrt.StringFromLiteral("haxe/io/Input.hx")
			hx_obj_99["lineNumber"] = 18
			hx_obj_99["className"] = hxrt.StringFromLiteral("haxe.io.Input")
			hx_obj_99["methodName"] = hxrt.StringFromLiteral("readByte")
			return hx_obj_99
		}()))
		var hx_throw_zero_100 int
		return hx_throw_zero_100
	}()
}
...
func (self *haxe__io__Input) readBytes(bytes *haxe__io__Bytes, pos int, len int) int {
	...
	}, func(hx_caught_101 any) {
		switch hx_typed_102 := hx_caught_101.(type) {
		case *haxe__io__Eof:
			hx_tmp := hx_typed_102
			_ = hx_tmp
		default:
			hxrt.Throw(hx_caught_101)
		}
	})
...
func (self *haxe__io__Input) readAll(bufsize any) *haxe__io__Bytes {
	...
	}, func(hx_caught_103 any) {
		switch hx_typed_104 := hx_caught_103.(type) {
		case *haxe__io__Eof:
			hx_tmp := hx_typed_104
			_ = hx_tmp
		default:
			hxrt.Throw(hx_caught_103)
		}
	})
...
func (self *haxe__io__Input) readLine() *string {
	...
	hxrt.TryCatch(func() {
		...
		switch hx_typed_106 := hx_caught_105.(type) {
		case *haxe__io__Eof:
			error := hx_typed_106
			result = buffer.__hx_this.getBytes().__hx_this.toString()
...
func (self *haxe__io__Input) readDouble() float64 {
	...
	var hx_if_107 float64
	if self.bigEndian {
		hx_if_107 = haxe__io__FPHelper_i64ToDouble(second, first)
	} else {
		hx_if_107 = haxe__io__FPHelper_i64ToDouble(first, second)
	}
	return hx_if_107
}
...
func (self *haxe__io__Input) readInt8() int {
	...
	var hx_if_108 int
	if value >= 128 {
		hx_if_108 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(256))))
	} else {
		hx_if_108 = value
	}
	return hx_if_108
...
func (self *haxe__io__Input) readInt16() int {
	...
	var hx_if_109 int
	if self.bigEndian {
		hx_if_109 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_109 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	value := hx_if_109
	var hx_if_110 int
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(32768)))) != 0 {
		hx_if_110 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(65536))))
	} else {
		hx_if_110 = value
	}
	return hx_if_110
...
func (self *haxe__io__Input) readUInt16() int {
	...
	var hx_if_111 int
	if self.bigEndian {
		hx_if_111 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_111 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	return hx_if_111
}
...
func (self *haxe__io__Input) readInt24() int {
	...
	var hx_if_112 int
	if self.bigEndian {
		hx_if_112 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_112 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	value := hx_if_112
	var hx_if_113 int
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(8388608)))) != 0 {
		hx_if_113 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(16777216))))
	} else {
		hx_if_113 = value
	}
	return hx_if_113
...
func (self *haxe__io__Input) readUInt24() int {
	...
	var hx_if_114 int
	if self.bigEndian {
		hx_if_114 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_114 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	return hx_if_114
}
...
func (self *haxe__io__Input) readInt32() int {
	...
	var hx_if_115 int
	if self.bigEndian {
		hx_if_115 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(24))))))))
	} else {
		hx_if_115 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) << uint(24))))))))
	}
	return hx_if_115
}
