...
import (
	...
	"encoding/hex"
	"encoding/xml"
	"examples_tui_todo_portable/hxrt"
	"io"
	"math"
	"reflect"
	"strings"
...
func hxrt_typeCreateClassInstance(className string, args []any) (any, bool) {
	...
	case "StringTools":
		return nil, false
	case "app.TodoApp":
		return hxrt_typeCallAny(New_app__TodoApp, args)
	...
	case "model.TodoItem":
		return hxrt_typeCallAny(New_model__TodoItem, args)
...
func Type_getClass(o any) any {
	...
	case *app__TodoApp:
		...
		return &hxrt__TypeClassValue{name: hxrt.StringFromLiteral("app.TodoApp")}
	...
	case *model__TodoItem:
		if value == nil {
			return nil
		}
		return &hxrt__TypeClassValue{name: hxrt.StringFromLiteral("model.TodoItem")}
	case *model__TodoStore:
		if value == nil {
			return nil
		}
		return &hxrt__TypeClassValue{name: hxrt.StringFromLiteral("model.TodoStore")}
	case *profile__PortableRuntime:
		if value == nil {
			return nil
		}
...
func Type_getClassFields(c any) []*string {
	...
	switch className {
	case "Harness":
		return []*string{hxrt.StringFromLiteral("assertContract"), hxrt.StringFromLiteral("batchTitles"), hxrt.StringFromLiteral("run"), hxrt.StringFromLiteral("runBaseline")}
	case "InteractiveCli":
		return []*string{hxrt.StringFromLiteral("STATE_FILE"), hxrt.StringFromLiteral("clearState"), hxrt.StringFromLiteral("decodeTags"), hxrt.StringFromLiteral("decodeToken"), hxrt.StringFromLiteral("encodeField"), hxrt.StringFromLiteral("encodeTags"), hxrt.StringFromLiteral("failUsage"), hxrt.StringFromLiteral("listIndex"), hxrt.StringFromLiteral("loadState"), hxrt.StringFromLiteral("parsePositiveInt"), hxrt.StringFromLiteral("printHelp"), hxrt.StringFromLiteral("printUsage"), hxrt.StringFromLiteral("run"), hxrt.StringFromLiteral("saveState"), hxrt.StringFromLiteral("splitEscaped"), hxrt.StringFromLiteral("splitRaw")}
	case "Main":
	...
	case "app.TodoApp":
		return []*string{hxrt.StringFromLiteral("joinStringList")}
	case "haxe.Int64Helper":
		return []*string{}
	case "haxe._Int32.Int32_Impl_":
		return []*string{}
