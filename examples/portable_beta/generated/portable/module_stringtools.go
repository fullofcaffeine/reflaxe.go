...
func StringTools_hex(n int, digits any) *string {
	...
	hx_do_first_156 := true
	for hx_do_first_156 || (value > 0) {
		hx_do_first_156 = false
	...
	if digits == nil {
		...
		hx_if_157 = digits.(int)
	}
	resolvedDigits := hx_if_157
...
func StringTools_ltrim(s *string) *string {
	...
	if r > 0 {
		hx_if_160 = hxrt.StringSubstrStringPtr(s, r, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_160 = s
	}
	return hx_if_160
...
func StringTools_rtrim(s *string) *string {
	...
	var hx_if_162 *string
	if r > 0 {
		hx_if_162 = hxrt.StringSubstrStringPtr(s, 0, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_162 = s
	}
	return hx_if_162
