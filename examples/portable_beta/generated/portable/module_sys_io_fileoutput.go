...
func (self *sys__io__FileOutput) writeBytes(bytes *haxe__io__Bytes, pos int, length int) int {
	...
	return hxrt.FileOutputWriteValues(self.handle, func(hx_lambda_raw_27 []any) []int {
		hx_lambda_out_28 := make([]int, 0, len(hx_lambda_raw_27))
		for _, hx_lambda_item_29 := range hx_lambda_raw_27 {
			hx_lambda_out_28 = append(hx_lambda_out_28, func(hx_value_30 any) int {
				if hx_value_30 == nil {
					var hx_zero_31 int
					return hx_zero_31
				}
