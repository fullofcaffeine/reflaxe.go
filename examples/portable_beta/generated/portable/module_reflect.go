...
func Reflect_fields(o any) *hxrt.Array {
	...
	return hxrt.ArrayFromValues(func(hx_sort_src_172 []*string) []any {
		hx_sort_out_174 := make([]any, 0, len(hx_sort_src_172))
		for _, hx_sort_item_173 := range hx_sort_src_172 {
			hx_sort_out_174 = append(hx_sort_out_174, hx_sort_item_173)
		}
		return hx_sort_out_174
...
func Reflect_getProperty(o any, field *string) any {
	...
	if hxrt.AnyEqualsNull(getter) {
		hx_if_175 = Reflect_field(o, field)
	} else {
		hx_if_175 = Reflect_callMethod(o, getter, hxrt.NewArray())
	}
	return hx_if_175
}
