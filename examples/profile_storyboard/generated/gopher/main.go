...
func (self *profile__GopherRuntime) decorateTitle(title *string) *string {
	return hxrt.StringConcatStringPtr(title, hxrt.StringFromLiteral(" [go]"))
}
...
func (self *profile__GopherRuntime) extraSignal(cards *haxe__ds__List) *string {
	...
	return hxrt.StringConcatAny(hxrt.StringFromLiteral("interop_lane=typed,total_points="), total)
}
