...
func (self *haxe__io__Input) readByte() int {
	return func() int {
		hxrt.Throw(New_haxe__exceptions__NotImplementedException(nil, nil, func() map[string]any {
			...
			hx_obj_156["fileName"] = hxrt.StringFromLiteral("haxe/io/Input.hx")
			hx_obj_156["lineNumber"] = 18
			hx_obj_156["className"] = hxrt.StringFromLiteral("haxe.io.Input")
			hx_obj_156["methodName"] = hxrt.StringFromLiteral("readByte")
			return hx_obj_156
		}()))
		var hx_throw_zero_157 int
		return hx_throw_zero_157
	}()
}
...
func (self *haxe__io__Input) readBytes(bytes *haxe__io__Bytes, pos int, len int) int {
	...
	}, func(hx_caught_158 any) {
		switch hx_typed_159 := hx_caught_158.(type) {
		case *haxe__io__Eof:
			hx_tmp := hx_typed_159
			_ = hx_tmp
		default:
			hxrt.Throw(hx_caught_158)
		}
	})
...
func (self *haxe__io__Input) readAll(bufsize any) *haxe__io__Bytes {
	...
	}, func(hx_caught_160 any) {
		switch hx_typed_161 := hx_caught_160.(type) {
		case *haxe__io__Eof:
			hx_tmp := hx_typed_161
			_ = hx_tmp
		default:
			hxrt.Throw(hx_caught_160)
		}
	})
...
func (self *haxe__io__Input) readLine() *string {
	...
	}, func(hx_caught_162 any) {
		switch hx_typed_163 := hx_caught_162.(type) {
		case *haxe__io__Eof:
			error := hx_typed_163
			result = buffer.__hx_this.getBytes().__hx_this.toString()
...
func (self *haxe__io__Input) readDouble() float64 {
	...
	var hx_if_164 float64
	if self.bigEndian {
		hx_if_164 = haxe__io__FPHelper_i64ToDouble(second, first)
	} else {
		hx_if_164 = haxe__io__FPHelper_i64ToDouble(first, second)
	}
	return hx_if_164
}
...
func (self *haxe__io__Input) readInt8() int {
	...
	var hx_if_165 int
	if value >= 128 {
		hx_if_165 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(256))))
	} else {
		hx_if_165 = value
	}
	return hx_if_165
...
func (self *haxe__io__Input) readInt16() int {
	...
	var hx_if_166 int
	if self.bigEndian {
		hx_if_166 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_166 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	value := hx_if_166
	var hx_if_167 int
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(32768)))) != 0 {
		hx_if_167 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(65536))))
	} else {
		hx_if_167 = value
	}
	return hx_if_167
...
func (self *haxe__io__Input) readUInt16() int {
	...
	var hx_if_168 int
	if self.bigEndian {
		hx_if_168 = int(int32((hxrt.Int32Wrap(second) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(8))))))))
	} else {
		hx_if_168 = int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))
	}
	return hx_if_168
}
...
func (self *haxe__io__Input) readInt24() int {
	...
	var hx_if_169 int
	if self.bigEndian {
		hx_if_169 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_169 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	value := hx_if_169
	var hx_if_170 int
	if int(int32((hxrt.Int32Wrap(value) & hxrt.Int32Wrap(8388608)))) != 0 {
		hx_if_170 = int(int32((hxrt.Int32Wrap(value) - hxrt.Int32Wrap(16777216))))
	} else {
		hx_if_170 = value
	}
	return hx_if_170
...
func (self *haxe__io__Input) readUInt24() int {
	...
	var hx_if_171 int
	if self.bigEndian {
		hx_if_171 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(16))))))))
	} else {
		hx_if_171 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))
	}
	return hx_if_171
}
...
func (self *haxe__io__Input) readInt32() int {
	...
	var hx_if_172 int
	if self.bigEndian {
		hx_if_172 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) << uint(24))))))))
	} else {
		hx_if_172 = int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(first) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(second) << uint(8))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(third) << uint(16))))))))) | hxrt.Int32Wrap(int(int32((hxrt.Int32Wrap(fourth) << uint(24))))))))
	}
	return hx_if_172
}
