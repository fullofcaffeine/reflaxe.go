...
func StringTools_hex(n int, digits any) *string {
	...
	hx_do_first_71 := true
	for hx_do_first_71 || (value > 0) {
		hx_do_first_71 = false
...
func StringTools_ltrim(s *string) *string {
	...
	var hx_if_75 *string
	if r > 0 {
		hx_if_75 = hxrt.StringSubstrStringPtr(s, r, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_75 = s
	}
	return hx_if_75
...
func StringTools_rtrim(s *string) *string {
	...
	var hx_if_77 *string
	if r > 0 {
		hx_if_77 = hxrt.StringSubstrStringPtr(s, 0, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_77 = s
	}
	return hx_if_77
