...
func StringTools_hex(n int, digits any) *string {
	...
	hx_do_first_89 := true
	for hx_do_first_89 || (value > 0) {
		hx_do_first_89 = false
...
func StringTools_ltrim(s *string) *string {
	...
	var hx_if_93 *string
	if r > 0 {
		hx_if_93 = hxrt.StringSubstrStringPtr(s, r, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_93 = s
	}
	return hx_if_93
...
func StringTools_rtrim(s *string) *string {
	...
	var hx_if_95 *string
	if r > 0 {
		hx_if_95 = hxrt.StringSubstrStringPtr(s, 0, int(int32((hxrt.Int32Wrap(hxrt.StringLengthStringPtr(s)) - hxrt.Int32Wrap(r)))), true)
	} else {
		hx_if_95 = s
	}
	return hx_if_95
