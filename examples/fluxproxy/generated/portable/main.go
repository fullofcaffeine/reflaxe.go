...
import (
	...
	"encoding/hex"
	"encoding/xml"
	"examples_fluxproxy_portable/hxrt"
	"io"
	"math"
	"reflect"
	"strings"
...
func Type_getClassFields(c any) []*string {
	...
	switch className {
	case "Harness":
		return []*string{hxrt.StringFromLiteral("assertBreakerScenario"), hxrt.StringFromLiteral("assertContract"), hxrt.StringFromLiteral("baselineRequests"), hxrt.StringFromLiteral("cloneRequests"), hxrt.StringFromLiteral("run"), hxrt.StringFromLiteral("runReport"), hxrt.StringFromLiteral("runWithRequests")}
	case "InteractiveCli":
		return []*string{hxrt.StringFromLiteral("decodeToken"), hxrt.StringFromLiteral("failUsage"), hxrt.StringFromLiteral("liveLine"), hxrt.StringFromLiteral("nextId"), hxrt.StringFromLiteral("parsePositiveInt"), hxrt.StringFromLiteral("printHelp"), hxrt.StringFromLiteral("printUsage"), hxrt.StringFromLiteral("run"), hxrt.StringFromLiteral("runReport")}
	case "Main":
	...
	case "app.core.FluxCodec":
		return []*string{hxrt.StringFromLiteral("breakerOpen"), hxrt.StringFromLiteral("normalizedRoute"), hxrt.StringFromLiteral("proxy"), hxrt.StringFromLiteral("rateLimited"), hxrt.StringFromLiteral("upstreamForRoute")}
	case "app.core.FluxIngestResult":
		return []*string{}
	case "app.core.FluxPipeline":
		return []*string{}
	...
	case "app.core.FluxRouteAggregate":
		return []*string{}
	case "app.runtime.BuildConfig":
		return []*string{hxrt.StringFromLiteral("BREAKER_FAILURE_THRESHOLD"), hxrt.StringFromLiteral("DISPATCH_WORKERS"), hxrt.StringFromLiteral("INGEST_QUEUE_CAPACITY"), hxrt.StringFromLiteral("PER_ROUTE_LIMIT"), hxrt.StringFromLiteral("PROFILE"), hxrt.StringFromLiteral("TIMEOUT_MS"), hxrt.StringFromLiteral("VARIANT")}
	case "app.runtime.CoreRuntime":
		return []*string{}
	case "app.runtime.RuntimeFactory":
...
func Type_getInstanceFields(c any) []*string {
	...
	case "app.core.FluxPipeline":
		return []*string{hxrt.StringFromLiteral("aggregate"), hxrt.StringFromLiteral("applyRoutePolicies"), hxrt.StringFromLiteral("errors"), hxrt.StringFromLiteral("findRouteAggregate"), hxrt.StringFromLiteral("getResponseById"), hxrt.StringFromLiteral("getStringIntStateValue"), hxrt.StringFromLiteral("ingest"), hxrt.StringFromLiteral("orderedResponses"), hxrt.StringFromLiteral("retries"), hxrt.StringFromLiteral("run"), hxrt.StringFromLiteral("runtime"), hxrt.StringFromLiteral("setResponseById"), hxrt.StringFromLiteral("setStringIntStateValue")}
	case "app.core.FluxProxyResponse":
