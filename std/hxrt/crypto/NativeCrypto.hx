...
/**
	...
	How:
	- Pass only explicit `NativeSlice<Int>` byte values, strings, and a URL-safe selector to
...
extern class NativeCrypto {
	...
	public static function base64Encode(values:NativeSlice<Int>, urlSafe:Bool):String;

	@:go.name("CryptoBase64Decode")
	public static function base64Decode(value:String, urlSafe:Bool):NativeSlice<Int>;

	@:go.name("CryptoMd5String")
	public static function md5String(value:String):String;

	@:go.name("CryptoMd5Values")
	public static function md5Values(values:NativeSlice<Int>):NativeSlice<Int>;

	@:go.name("CryptoSha1String")
	public static function sha1String(value:String):String;

	@:go.name("CryptoSha1Values")
	public static function sha1Values(values:NativeSlice<Int>):NativeSlice<Int>;

	@:go.name("CryptoSha224String")
	public static function sha224String(value:String):String;

	@:go.name("CryptoSha224Values")
	public static function sha224Values(values:NativeSlice<Int>):NativeSlice<Int>;

	@:go.name("CryptoSha256String")
	public static function sha256String(value:String):String;

	@:go.name("CryptoSha256Values")
	public static function sha256Values(values:NativeSlice<Int>):NativeSlice<Int>;
}
